...
\end{equation*}
\begin{equation*}
    g_{a b} \rightarrow \Tilde{g}_{a b} = g_{a b} + k \Delta \delta _{a b}
\end{equation*}
\begin{equation*}
    \downarrow
\end{equation*}
\begin{equation*}
    g^{a b} \rightarrow \Tilde{g}^{a b} \approx g^{a b} - k \Delta \delta ^{a b}
\end{equation*}
\begin{equation*}
    \downarrow
\end{equation*}
\begin{equation*}
    S = - \frac{T}{2} \int \diff ^2 x \left( \sqrt{- g} - \frac{k \Delta}{2 \sqrt{- g}} \right) \left( g^{a b} - k \Delta \delta ^{a b} \right) \partial _{a} X^{\mu} \partial _{b} X^{\nu} \widetilde{G}_{\mu \nu} ,
\end{equation*}
\begin{equation*}
    \widetilde{G}_{\mu \nu} = G_{\mu \nu} + k \Theta \delta _{\mu \nu} ,
\end{equation*}
...
\begin{align*}
    \frac{\delta S}{\delta g^{c d}} & = \frac{\partial}{\partial g^{c d}} \left( \sqrt{- g} - \frac{k \Delta}{2 \sqrt{- g}} \right) \left( g^{a b} - k \Delta \delta ^{a b} \right) \partial _{a} X^{\mu} \partial _{b} X^{\nu} \widetilde{G}_{\mu \nu} + \\
                                    & + \left( \sqrt{- g} - \frac{k \Delta}{2 \sqrt{- g}} \right) \frac{\partial}{\partial g^{c d}} \left( g^{a b} - k \Delta \delta ^{a b} \right) \partial _{a} X^{\mu} \partial _{b} X^{\nu} \widetilde{G}_{\mu \nu} = \\
                                    & = \left( - \frac{1}{2} \sqrt{- g} g_{c d} + \frac{k \Delta}{4 \sqrt{- g}} g_{c d} \right) \left( g^{a b} - k \Delta \delta ^{a b} \right) \partial _{a} X^{\mu} \partial _{b} X^{\nu} \widetilde{G}_{\mu \nu} +     \\
                                    & + \left( \sqrt{- g} - \frac{k \Delta}{2 \sqrt{- g}} \right) \delta ^{a} _{c} \delta ^{b} _{d} \partial _{a} X^{\mu} \partial _{b} X^{\nu} \widetilde{G}_{\mu \nu} =                                                 \\
                                    & = - \frac{1}{2} \left( \sqrt{- g} - \frac{k \Delta}{2 \sqrt{- g}} \right) g_{c d} \left( g^{a b} - k \Delta \delta ^{a b} \right) \partial _{a} X^{\mu} \partial _{b} X^{\nu} \widetilde{G}_{\mu \nu} +             \\
                                    & + \left( \sqrt{- g} - \frac{k \Delta}{2 \sqrt{- g}} \right) \partial _{c} X^{\mu} \partial _{d} X^{\nu} \widetilde{G}_{\mu \nu} \overset{!}{=} 0
\end{align*}
\begin{equation*}
    \downarrow
\end{equation*}
\begin{equation*}
    T_{c d} := \partial _{c} X^{\mu} \partial _{d} X^{\nu} \widetilde{G}_{\mu \nu} - \frac{1}{2} g_{c d} \left( g^{a b} - k \Delta \delta ^{a b} \right) \partial _{a} X^{\mu} \partial _{b} X^{\nu} \widetilde{G}_{\mu \nu} = 0
\end{equation*}
\begin{equation*}
    g_{c d} = 2 f \partial _{c} X^{\mu} \partial _{d} X^{\nu} \widetilde{G}_{\mu \nu} ,
\end{equation*}
\begin{align*}
    \frac{1}{f} & = \left( g^{a b} - k \Delta \delta ^{a b} \right) \partial _{a} X^{\mu} \partial _{b} X^{\nu} \widetilde{G}_{\mu \nu} =                                                                                                                   \\
                & = g^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} G_{\mu \nu} - k \Theta g^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} \delta _{\mu \nu} -                                                                                      \\
                & - k \Delta \delta ^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} G_{\mu \nu} - k^2 \Delta \Theta \delta ^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} \delta _{\mu \nu} \approx                                                  \\
                & \approx g^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} G_{\mu \nu} - k \Theta g^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} \delta _{\mu \nu} - k \Delta \delta ^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} G_{\mu \nu}
\end{align*}
...
\begin{multline*}
    ...
    - \left( \left( \frac{\partial \tau}{\partial x} \right) ^2 \frac{\partial ^2 X^{\mu}}{\partial \tau ^2} + 2 \frac{\partial \tau}{\partial x} \frac{\partial \sigma}{\partial x} \frac{\partial ^2 X^{\mu}}{\partial \tau \partial \sigma} + \left( \frac{\partial \sigma}{\partial x} \right) ^2 \frac{\partial ^2 X^{\mu}}{\partial \sigma ^2} \right) = 0 ,
\end{multline*}
which comparing to what is obtained from the Polyakov analysis
\begin{equation*}
    \frac{\partial ^2 X^{\mu}}{\partial \sigma ^2} - \frac{\partial ^2 X^{\mu}}{\partial \tau ^2} - m^2 X^{\mu} = 0 ,
\end{equation*}
we get
\begin{align*}
    (F^{+})^2 \left( \frac{\partial \sigma}{\partial t} \right) ^2 - \left( \frac{\partial \sigma}{\partial x} \right) ^2                                                                                                                                                       & = 1               \\
    (F^{+})^2 \left( \frac{\partial \tau}{\partial t} \right) ^2 - \left( \frac{\partial \tau}{\partial x} \right) ^2                                                                                                                                                           & = - 1             \\
    2 (F^{+})^2 \frac{\partial \tau}{\partial t} \frac{\partial \sigma}{\partial t} \frac{\partial ^2 X^{\mu}}{\partial \tau \partial \sigma} - 2 \frac{\partial \tau}{\partial x} \frac{\partial \sigma}{\partial x} \frac{\partial ^2 X^{\mu}}{\partial \tau \partial \sigma} & = - m^2 X^{\mu} ,
\end{align*}
