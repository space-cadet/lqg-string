...
\begin{equation*}
	S' = - \frac{T}{2} \int \diff ^2 x e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} \mc{D}' _{a} X^{\prime I} \mc{D}' _{b} X^{\prime J} \eta _{I J} =
\end{equation*}
\begin{equation*}
	= - \frac{T}{2} \int \diff ^2 x e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} \PS ^{I} _{\ K} \mc{D}_{a} X^{K} \PS ^{J} _{\ L} \mc{D}_{b} X^{L} \eta _{I J} ,
\end{equation*}
so we promote the killing form $\eta _{I J}$ to a doubly-contravariant form $K_{I J}$ such that $K' _{I J} = (\PS ^{-1})_{\ \ I} ^{M} (\PS ^{-1})_{\ \ J} ^{N} K_{M N}$
\begin{equation*}
	S = - \frac{T}{2} \int \diff ^2 x e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} \mc{D}_{a} X^{I} \mc{D}_{b} X^{J} K_{I J} .
\end{equation*}
Clearly, since $\PS = \PS (x)$, $K$ must also be a WS field $K_{I J} = K_{I J} (x)$.
