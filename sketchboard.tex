...
\begin{equation*}
    X^{\mu} \rightarrow X^{\mu} _{i j} \ , \ \ i , j = 0 , 1
\end{equation*}
...
\begin{equation*}
    S_{M P 4} = - \frac{T}{2} \int \diff \tau \wedge \diff \sigma e e^{a} _{k} e^{b k} D_{a} X^{\mu} _{i j} \eta ^{j m} \eta ^{i n} D_{b} X^{\nu} _{m n} E^{I} _{\mu} E_{\nu I}
\end{equation*}
...
\begin{align*}
    \frac{\delta S_{M P 3}}{\delta \omega ^{m n} _{c}} & = \frac{D \Lagr _{M P 3}}{D \omega ^{m n} _{c}} = \left( \frac{\partial}{\partial \omega ^{m n} _{c}} - \partial _{d} \frac{\partial}{\partial (\partial _{d} \omega ^{m n} _{c})} \right) \left( - \frac{T}{2} \det (e) \eta ^{i j} e^{a} _{i} e^{b} _{j} D_{a} (X^{\mu} _{k} v^{k}) D_{b} (X^{\nu} _{l} v^{l}) E_{\mu} ^{I} E_{\nu} ^{J} \eta _{I J} \right) = \\
                                                       & = - \frac{T}{4} e g^{a b} ((- \delta ^{c} _{a} \delta ^{k'} _{[m} \eta _{n] k} X^{\mu} _{k'} v^{k} + X^{\mu} _{k} \delta ^{c} _{a} \delta ^{k} _{[m} \eta _{n] k'} v^{k'}) D_{b} (X^{\nu} _{l} v^{l}) +                                                                                                                                                          \\
                                                       & + D_{a} (X^{\mu} _{k} v^{k}) (- \delta ^{c} _{b} \delta ^{l'} _{[m} \eta _{n] l} X^{\nu} _{l'} v^{l} + X^{\nu} _{l} \delta ^{c} _{b} \delta ^{l} _{[m} \eta _{n] l'} v^{l'})) G_{\mu \nu} = 0
\end{align*}
