...
Analysing the constraints, starting by the mixed one we get
\begin{equation*}
    \partial _{\tau} X^{\mu} \partial _{\sigma} X^{\nu} \eta _{\mu \nu} = - \frac{\eta _{\mu \nu}}{16 \pi ^2 (\alpha ')^2} \sum _{n} \sum _{k} \frac{k}{E_{k}} \Big( - a^{\mu} _{n} \e ^{i (- E_{n} \tau + n \sigma)} + (a^{\mu} _{- n})^{*} \e ^{i (E_{n} \tau + n \sigma)} \Big) \Big( a^{\nu} _{k} \e ^{i (- E_{k} \tau + k \sigma)} + (a^{\nu} _{- k})^{*} \e ^{i (E_{k} \tau + k \sigma)} \Big) =
\end{equation*}
\begin{multline*}
    = - \frac{\eta _{\mu \nu}}{16 \pi ^2 (\alpha ')^2} \sum _{n} \sum _{k} \frac{k}{E_{k}} \Big( - a^{\mu} _{n} a^{\nu} _{k} \e ^{- i (E_{n} + E_{k}) \tau} \e ^{i (n + k) \sigma} - a^{\mu} _{n} (a^{\nu} _{- k})^{*} \e ^{- i (E_{n} - E_{k}) \tau} \e ^{i (n + k) \sigma} + \\
    + (a^{\mu} _{- n})^{*} a^{\nu} _{k} \e ^{i (E_{n} - E_{k}) \tau} \e ^{i (n + k) \sigma} + (a^{\mu} _{- n})^{*} (a^{\nu} _{- k})^{*} \e ^{i (E_{n} + E_{k}) \tau} \e ^{i (n + k) \sigma} \Big) =
\end{multline*}
\begin{multline*}
    = - \frac{\eta _{\mu \nu}}{16 \pi ^2 (\alpha ')^2} \sum _{n} \sum _{p} \frac{p - n}{E_{p - n}} \Big( - a^{\mu} _{n} a^{\nu} _{p - n} \e ^{- i (E_{n} + E_{p - n}) \tau} \e ^{i p \sigma} - a^{\mu} _{n} (a^{\nu} _{n - p})^{*} \e ^{- i (E_{n} - E_{p - n}) \tau} \e ^{i p \sigma} + \\
    + (a^{\mu} _{- n})^{*} a^{\nu} _{p - n} \e ^{i (E_{n} - E_{p - n}) \tau} \e ^{i p \sigma} + (a^{\mu} _{- n})^{*} (a^{\nu} _{n - p})^{*} \e ^{i (E_{n} + E_{p - n}) \tau} \e ^{i p \sigma} \Big) = 0 ,
\end{multline*}
where since this must hold for all values of $\tau$ and $\sigma$, each term must vanish separately, giving us
\begin{align*}
    \sum _{n} \sum_{p} \frac{p - n}{E_{p - n}} a^{\mu} _{n} a^{\nu} _{p - n} \eta _{\mu \nu} \e ^{- i (E_{n} + E_{p - n}) \tau} \e ^{i p \sigma}             & = 0   \\
    \sum _{n} \sum_{p} \frac{p - n}{E_{p - n}} a^{\mu} _{n} (a^{\nu} _{n - p})^{*} \eta _{\mu \nu} \e ^{- i (E_{n} - E_{p - n}) \tau} \e ^{i p \sigma}       & = 0   \\
    \sum _{n} \sum_{p} \frac{p - n}{E_{p - n}} (a^{\mu} _{- n})^{*} a^{\nu} _{p - n} \eta _{\mu \nu} \e ^{i (E_{n} - E_{p - n}) \tau} \e ^{i p \sigma}       & = 0   \\
    \sum _{n} \sum_{p} \frac{p - n}{E_{p - n}} (a^{\mu} _{- n})^{*} (a^{\nu} _{n - p})^{*} \eta _{\mu \nu} \e ^{i (E_{n} + E_{p - n}) \tau} \e ^{i p \sigma} & = 0 .
\end{align*}
The 2 middle equations are just complex conjugates of each other, so they are redundant. The same is true for the first and last. This leaves us with
\begin{align*}
    L_{n , p}             & := \frac{p - n}{E_{p - n}} a^{\mu} _{n} a^{\nu} _{p - n} \eta _{\mu \nu} = 0         \\
    \widetilde{L}_{n , p} & := \frac{p - n}{E_{p - n}} a^{\mu} _{n} (a^{\nu} _{n - p})^{*} \eta _{\mu \nu} = 0 .
\end{align*}
...
\begin{align*}
    L_{n , p}             & = \frac{p - n}{E_{p - n}} \alpha ^{\mu} _{n} \alpha ^{\nu} _{n - p} \eta _{\mu \nu} = 0         \\
    \widetilde{L}_{n , p} & = \frac{p - n}{E_{p - n}} \alpha ^{\mu} _{n} (\alpha ^{\nu} _{n - p})^{*} \eta _{\mu \nu} = 0 ,
\end{align*}
...
\end{equation*}
When translating the constraints into quantum operators, in $L_{n , p}$ we have no ambiguity of ordering since $\Hat{\alpha}$ commutes with itself for different indices. As for $\widetilde{L}_{n , p}$, there is an ambiguity for $p = 0$, and so we pick normal ordering with the annihilation operators moved to the right
\begin{equation*}
    \Hat{\widetilde{L}}_{n , 0} = \frac{- n}{E_{n}} (\Hat{\alpha} ^{\mu} _{n})^{\dagger} \Hat{\alpha} ^{\nu} _{n} \eta _{\mu \nu} .
\end{equation*}
The ambiguity manifests in the imposition of this constraint as
\begin{equation*}
    \bra{\mathrm{phys }'} (\Hat{\widetilde{L}}_{n , 0} - a) \ket{\mathrm{phys}} = 0 ,
\end{equation*}
for some constant $a$. Since classically
\begin{equation*}
    M^2 = - p^{\mu} p_{\mu} = - \frac{1}{(4 \pi (\alpha ')^2)^2} \alpha ^{\mu} _{0} (\alpha ^{\nu} _{0})^{*} \eta _{\mu \nu} = - \frac{1}{(4 \pi (\alpha ')^2)^2} \lim _{n \rightarrow 0} \left( - \frac{E_{n}}{n} \widetilde{L}_{n , 0} \right) ,
\end{equation*}
we see that the string mass spectrum will be shifted by
\begin{equation*}
    \Hat{M}^2 = - \frac{1}{(4 \pi (\alpha ')^2)^2} \left( (\Hat{\alpha} ^{\mu} _{0})^{\dagger} \Hat{\alpha}^{\nu} _{0} \eta _{\mu \nu} + \lim _{n \rightarrow 0} \frac{E_{n}}{n} a \right) ,
\end{equation*}
so either the mass spectrum of the string diverges, or the constant $a$ isn't so constant and $a = \mu n$, making the limit equal to $\mu E_{0} = \mu ^2$, the KG \textquotedblleft mass" term.
...
\end{equation*}
\begin{align*}
    \Big[ \Hat{L}_{n , m} , \Hat{\widetilde{L}}_{p , k} \Big] & = \Big[ \frac{m - n}{E_{m - n}} \Hat{\alpha}^{\mu} _{n} \Hat{\alpha}^{\nu} _{n - m} \eta _{\mu \nu} , \frac{k - p}{E_{k - p}} (\Hat{\alpha}^{\mu '} _{k})^{\dagger} \Hat{\alpha}^{\nu '} _{k - p} \eta _{\mu ' \nu '} \Big] =                                                                                                                                                                                                \\
                                                              & = \frac{(m - n)}{E_{m - n}} \frac{(k - p)}{E_{k - p}} \left(  \eta _{\mu \nu} \Big[ \Hat{\alpha}^{\mu} _{n} \Hat{\alpha}^{\nu} _{n - m} , (\Hat{\alpha}^{\mu '} _{k})^{\dagger} \Big] \Hat{\alpha}^{\nu '} _{k - p} \eta _{\mu' \nu'} + \eta _{\mu \nu} (\Hat{\alpha}^{\mu '} _{k})^{\dagger} \Big[ \Hat{\alpha}^{\mu} _{n} \Hat{\alpha}^{\nu} _{n - m} , \Hat{\alpha}^{\nu '} _{k - p} \Big] \eta _{\mu ' \nu '} \right) =  \\
                                                              & = \frac{(m - n)}{E_{m - n}} \frac{(k - p)}{E_{k - p}} \left( \eta _{\mu \nu} \Hat{\alpha}^{\mu} _{n} \Big[ \Hat{\alpha}^{\nu} _{n - m} , (\Hat{\alpha}^{\mu '} _{k})^{\dagger} \Big] \Hat{\alpha}^{\nu '} _{k - p} \eta _{\mu ' \nu '} + \eta_{\mu \nu} \Big[ \Hat{\alpha}^{\mu} _{n} , (\Hat{\alpha}^{\mu '} _{k})^{\dagger} \Big] \Hat{\alpha}^{\nu} _{n - m} \Hat{\alpha} ^{\nu '} _{k - p} \eta _{\mu ' \nu '} \right) = \\
                                                              & = \frac{(m - n)}{E_{m - n}} \frac{(k - p)}{E_{k - p}} \eta _{\mu \nu} \eta _{\mu ' \nu '} \left( \Hat{\alpha}^{\mu} _{n} \eta ^{\nu \mu '} \delta _{n - m , k} \Hat{\alpha} ^{\nu '} _{k - p} + \eta ^{\mu \mu '} \delta _{n k} \Hat{\alpha}^{\nu} _{n - m} \Hat{\alpha}^{\nu '} _{k - p} \right) =                                                                                                                          \\
                                                              & = \frac{(m - n)}{E_{m - n}} \frac{(k - p)}{E_{k - p}} \eta _{\mu \nu} \left( \Hat{\alpha}^{\mu} _{n} \Hat{\alpha}^{\nu} _{k - p} \delta _{n - m , k} + \Hat{\alpha}^{\mu} _{n - m} \Hat{\alpha} ^{\nu} _{k - p} \delta _{n , k} \right) =                                                                                                                                                                                    \\
                                                              & = \frac{m - n}{E_{m - n}} \left( \Hat{L}_{n + k - p , n} \delta _{n - m , k} + \Hat{L}_{n - m + k - p , n - m} \delta _{n , k} \right)
\end{align*}
\begin{align*}
    \Big[ \Hat{\widetilde{L}}_{n , m} , \Hat{\widetilde{L}}_{p , k} \Big] & = \Big[ \frac{(m - n)}{E_{m - n}} (\Hat{\alpha}^{\mu} _{n})^{\dagger} \Hat{\alpha}^{\nu} _{n - m} \eta _{\mu \nu} , \frac{(k - p)}{E_{k - p}} (\Hat{\alpha}^{\mu '} _{k})^{\dagger} \Hat{\alpha}^{\nu '} _{k - p} \eta _{\mu ' \nu '} \Big] =                                                                                                                                                                    \\
                                                                          & = \frac{(m - n)}{E_{m - n}} \frac{(k - p)}{E_{k - p}} \eta _{\mu \nu} \eta _{\mu ' \nu '} \left( (\Hat{\alpha}^{\mu} _{n})^{\dagger} \Big[ \Hat{\alpha}^{\nu} _{n - m} , (\Hat{\alpha}^{\mu '} _{k})^{\dagger} \Big] \Hat{\alpha}^{\nu '} _{k - p} + (\Hat{\alpha}^{\mu '} _{k})^{\dagger} \Big[ (\Hat{\alpha}^{\mu} _{n})^{\dagger} , \Hat{\alpha}^{\nu '} _{k - p} \Big] \Hat{\alpha}^{\nu} _{n - m} \right) = \\
                                                                          & = \frac{(m - n)}{E_{m - n}} \frac{(k - p)}{E_{k - p}} \eta _{\mu \nu} \eta _{\mu ' \nu '} \left( (\Hat{\alpha}^{\mu} _{n})^{\dagger} \eta ^{\nu \mu '} \delta _{n - m , k} \Hat{\alpha}^{\nu '} _{k - p} + (\Hat{\alpha}^{\mu '} _{k})^{\dagger} \eta ^{\mu \nu '} \delta _{n , k - p} \Hat{\alpha}^{\nu} _{n - m} \right) =                                                                                     \\
                                                                          & = \frac{(m - n)}{E_{m - n}} \frac{(k - p)}{E_{k - p}} \eta _{\mu \nu} \left( (\Hat{\alpha}^{\mu} _{n})^{\dagger} \Hat{\alpha}^{\nu} _{k - p} \delta _{n - m , k} + (\Hat{\alpha}^{\mu} _{k})^{\dagger} \Hat{\alpha}^{\nu} _{n - m} \delta _{n , k - p} \right) =                                                                                                                                                 \\
                                                                          & = \frac{(m - n)}{E_{m - n}} \frac{(k - p)}{E_{k - p}} \left( \frac{E_{- n}}{(- n)} \Hat{\widetilde{L}}_{k - p - n , k - p} \delta _{n - m , k} + \frac{E_{- k}}{(- k)} \Hat{\widetilde{L}}_{n - m - k , n - m} \delta _{n , k - p} \right) .
\end{align*}
Since $[\Hat{L}_{n , m} , \Hat{\widetilde{L}}_{p , k}]$ only has annihilation operators, it has no ordering ambiguities. $[\Hat{\widetilde{L}}_{n , m} , \Hat{\widetilde{L}}_{p , k}]$ would have ordering ambiguities for $k - p = 0$ and $n - m = 0$, however in both cases regardless of the order the commutator would vanish because of the $(m - n)(k - p)$ factor multiplying the whole expression, and also $\Hat{\widetilde{L}}_{n , n} = 0$, so we would be commuting something with $0$, thus our algebra has no anomalous terms.

Considering the ground state $\ket{0 ; k}$, mass-shell condition
\begin{equation*}
    - (4 \pi (\alpha ')^2)^2 \Hat{M}^2 + \lim _{n \rightarrow 0} \frac{E_{n}}{n} \Hat{\widetilde{L}}_{n , 0} = \lim _{n \rightarrow 0} \frac{E_{n}}{n} c_{n}
\end{equation*}
implies
\begin{equation*}
    - (4 \pi (\alpha ')^2)^2 (M^2 + k^{\mu} k_{\mu}) = \lim _{n \rightarrow 0} \frac{E_{n}}{n} c_{n} .
\end{equation*}
Now considering states at the first excited level, given by $\zeta _{\mu} (\Hat{\alpha} ^{\mu} _{1})^{\dagger} \ket{0 ; k}$ with $\zeta _{\mu} (k)$ being a polarization vector, the mass-shell condition will now read
\begin{equation*}
    \left( - (4 \pi (\alpha ')^2)^2 \Hat{M}^2 + \lim _{n \rightarrow 0} \frac{E_{n}}{n} \Hat{\widetilde{L}}_{n , 0} \right) \zeta _{\mu} (\Hat{\alpha}^{\mu} _{1})^{\dagger} \ket{0 ; k} = \lim _{n \rightarrow 0} \frac{E_{n}}{n} c_{n} \zeta _{\mu} (\Hat{\alpha}^{\mu} _{1})^{\dagger} \ket{0 ; k}
\end{equation*}
\begin{equation*}
    \left( - (4 \pi (\alpha ')^2)^2 \Hat{M}^2 - \lim _{n \rightarrow 0} (\Hat{\alpha}^{\lambda} _{n})^{\dagger} \Hat{\alpha}^{\nu} _{n} \eta _{\lambda \nu} \right) \zeta _{\mu} (\Hat{\alpha}^{\mu} _{1})^{\dagger} \ket{0 ; k} = \lim _{n \rightarrow 0} \frac{E_{n}}{n} c_{n} \zeta _{\mu} (\Hat{\alpha}^{\mu} _{1})^{\dagger} \ket{0 ; k}
\end{equation*}
\begin{equation*}
    - (4 \pi (\alpha ')^2)^2 \Hat{M}^2 - \lim _{n \rightarrow 0} \eta _{\lambda \nu} \zeta _{\mu} \left( (\Hat{\alpha}^{\lambda} _{n})^{\dagger} (\Hat{\alpha}^{\mu} _{1})^{\dagger} \Hat{\alpha}^{\nu} _{n} + (\Hat{\alpha}^{\lambda} _{n})^{\dagger} \eta ^{\nu \mu} \delta _{n , 1} \right) \ket{0 ; k} = \lim _{n \rightarrow 0} \frac{E_{n}}{n} c_{n} \zeta _{\mu} (\Hat{\alpha}^{\mu} _{1})^{\dagger} \ket{0 ; k}
\end{equation*}
