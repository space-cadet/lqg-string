...
\end{equation*}
where the WS metric can be recast in terms of auxiliary zweibein fields as in
\begin{equation*}
...
\begin{equation*}
	\delta \Lagr = \delta (e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} \mc{D}_{a} X^{I} \mc{D}_{b} X^{J} \eta _{I J}) =
\end{equation*}
\begin{equation*}
	= e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} (\mc{D}_{a} \epsilon ^{I} \mc{D}_{b} X^{J} + \mc{D}_{a} X^{I} \mc{D}_{b} \epsilon ^{J}) \eta _{I J} =
\end{equation*}
\begin{equation*}
	= e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} (k \mc{A}^{I} _{a K} \epsilon^{K} \mc{D}_{b} X^{J} + \mc{D}_{a} X^{I} k \mc{A}^{J} _{b K} \epsilon ^{K}) \eta _{I J} =
\end{equation*}
\begin{equation*}
	= 2 e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} k \mc{A}^{I} _{a K} \epsilon ^{K} \mc{D}_{b} X^{J} \eta _{I J} =
\end{equation*}
\begin{equation*}
	= \mc{D}_{b} (2 e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} k \mc{A}^{I} _{a K} \epsilon ^{K} X^{J} \eta _{I J}) - X^{J} \mc{D}_{b} (2 e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} k \mc{A}^{I} _{a K} \epsilon ^{K} \eta _{I J}) =
\end{equation*}
\begin{equation*}
	= \partial _{b} (2 e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} k \mc{A}^{I} _{a K} \epsilon ^{K} X^{J} \eta _{I J}) - X^{J} \mc{D}_{b} (2 e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} k \mc{A}^{I} _{a K} \epsilon ^{K} \eta _{I J}) =
\end{equation*}
