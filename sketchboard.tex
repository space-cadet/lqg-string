...
..., promote partial derivative to covariant and add extra internal WS field $v_{i}$ leading us to
\begin{equation*}
    S_{M P 3} = - \frac{T}{2} \int \diff \tau \wedge \diff \sigma \det (e) \eta ^{i j} e^{a} _{i} e^{b} _{j} D_{a} X^{\mu k} v_{k} D_{b} X^{\nu l} v_{l} E_{\mu} ^{I} E_{\nu} ^{J} \eta _{I J}
\end{equation*}
