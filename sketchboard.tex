...
\end{align*}
Due to the fact that our source function is not written as a linear combination of our eigenfunctions, none of the terms of this sum are trivially 0, thus we must calculate the solution numerically by truncating at some desired point.
