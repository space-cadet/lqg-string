...
\end{equation*}
\begin{multline*}
    \frac{i}{8 \pi ^2 (\alpha ')^2} \sum _{p} \frac{1}{2 E_{k}} \bigg( - F^{-} \left\{ \alpha ^{\mu} _{k} , \alpha ^{\nu} _{p} \right\} \e ^{- i (E_{k} + E_{p}) \tau} \delta _{p , - m} + F^{-} \left\{ \alpha ^{\mu} _{k} , (\alpha ^{\nu} _{- p})^{*} \right\} \e ^{- i (E_{k} - E_{p}) \tau} \delta _{p , - m} - \\
    - F^{-} \left\{ (\alpha ^{\mu} _{- k})^{*} , \alpha ^{\nu} _{p} \right\} \e ^{i (E_{k} - E_{p}) \tau} \delta _{p , - m} + F^{-} \left\{ (\alpha ^{\mu} _{- k})^{*} , (\alpha ^{\nu} _{- p})^{*} \right\} \e ^{i (E_{k} + E_{p}) \tau} \delta _{p , - m} \bigg) = \frac{\eta ^{\mu \nu}}{2 \pi} \delta _{k , m}
\end{multline*}
\begin{multline*}
    \frac{i}{8 \pi ^2 (\alpha ')^2} \frac{1}{2 E_{k}} \bigg( - F^{-} \left\{ \alpha ^{\mu} _{k} , \alpha ^{\nu} _{- m} \right\} \e ^{- i (E_{k} + E_{m}) \tau} + F^{-} \left\{ \alpha ^{\mu} _{k} , (\alpha ^{\nu} _{m})^{*} \right\} \e ^{- i (E_{k} - E_{m}) \tau} - \\
