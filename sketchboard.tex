...
\end{multline*}
\begin{equation*}
    \Bigg\downarrow \frac{1}{2 \pi} \int _{0} ^{2 \pi} \diff \tau '
\end{equation*}
\begin{multline*}
    \frac{i}{16 \pi ^2 (\alpha ')^2 E_{m}} \sum _{l} \bigg( - A_{l} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i E_{m} \tau} \delta _{E_{k + l} , E_{l}} + \\
    + (A_{- l})^{*} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{- i E_{m} \tau} \delta _{E_{k + l} , E_{l}} - (A_{- l})^{*} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i E_{m} \tau} \delta _{E_{k + l} , E_{l}} + \\
    + (A_{- l})^{*} \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{i E_{m} \tau} \delta _{E_{k + l} , E_{l}} \bigg) = \frac{1}{2 \pi} \delta _{k , m} \eta ^{\mu \nu}
\end{multline*}
