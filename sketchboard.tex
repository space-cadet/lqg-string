...
\begin{equation*}
    \left\{ X^{\mu} (\tau , \sigma) , \Pi ^{\nu} (\tau , \sigma ') \right\} = \left\{ X^{\mu} (\tau , \sigma) , \frac{1}{4 \pi \alpha '} F^{-} (\tau , \sigma ') \partial _{\tau} X^{\nu} (\tau , \sigma ') \right\} = \delta (\sigma - \sigma ') \eta ^{\mu \nu}
\end{equation*}
\begin{equation*}
    \frac{1}{4 \pi \alpha '} \left( F^{-} (\tau , \sigma ') \left\{ X^{\mu} (\tau , \sigma) , \partial _{\tau} X^{\nu} (\tau , \sigma ') \right\} + \left\{ X^{\mu} (\tau , \sigma) , F^{-} (\tau , \sigma ') \right\} \partial _{\tau} X^{\nu} (\tau , \sigma ') \right) = \delta (\sigma - \sigma ') \eta ^{\mu \nu}
\end{equation*}
