...
\begin{equation*}
    h_{a b} = U_{a c} g^{c d} U_{d b} ,
\end{equation*}
where $U \in \mathrm{SO}(1 , 1)$, so we have a gauge freedom in choosing $h_{a b}$. This also implies
\begin{align*}
    \partial _{a} X^{\mu} \partial _{b} X^{\nu} H_{\mu \nu}                                       & = U_{a c} g^{c d} U_{d b} =                                                                                                                      \\
                                                                                                  & = U_{a c} \left( \frac{1}{2 g} \varepsilon ^{c c'} \varepsilon ^{d d'} g_{c' d'} \right) U_{d b} =                                               \\
    \delta _{a} ^{c'} \delta _{b} ^{d'} \partial _{c'} X^{\mu} \partial _{d'} X^{\nu} H_{\mu \nu} & = U_{a c} \left( \frac{1}{2 g} \varepsilon ^{c c'} \varepsilon ^{d d'} \partial _{c'} X^{\mu} \partial _{d'} X^{\nu} G_{\mu \nu} \right) U_{d b}
\end{align*}
\begin{equation*}
    \delta _{a} ^{c'} \delta _{b} ^{d'} H_{\mu \nu} = \frac{1}{2 g} U_{a c} \varepsilon ^{c c'} U_{d b} \varepsilon ^{d d'} G_{\mu \nu}
\end{equation*}
\begin{equation*}
    H_{\mu \nu} = - \frac{1}{8 g} U_{a c} \varepsilon ^{c a} U_{d b} \varepsilon ^{b d} G_{\mu \nu}
\end{equation*}
\begin{equation*}
    H_{\mu \nu} = - \frac{1}{8 g} (\Tr (U \varepsilon))^2 G_{\mu \nu} ,
\end{equation*}
where we must impose that $(\Tr (U \varepsilon))^2 = 8$ to recover the NG area corrected action.
...
\begin{equation*}
    \partial _{a} \left( \left( \sqrt{- g} g^{a b} - \frac{k \Delta}{2 (- g)} \sqrt{- g}^{-1} (U^{-1})^{a c} g_{c d} (U^{-1})^{d b} \right) \partial _{b} X^{\mu} \right) = 0 ,
\end{equation*}
