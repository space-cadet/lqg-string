...
\begin{equation*}
    h_{a b} = U_{a c} g^{c d} V_{d b} ,
\end{equation*}
where $U , V \in \mathrm{SL}(2 , \mathbb{C})$, so we have a gauge freedom in choosing $h_{a b}$. This also implies
\begin{align*}
    \partial _{a} X^{\mu} \partial _{b} X^{\nu} H_{\mu \nu}                                       & = U_{a c} g^{c d} V_{d b} =                                                                                                                      \\
                                                                                                  & = U_{a c} \left( \frac{1}{2 g} \varepsilon ^{c c'} \varepsilon ^{d d'} g_{c' d'} \right) V_{d b} =                                               \\
...
\end{align*}
\begin{equation*}
    \delta _{a} ^{c'} \delta _{b} ^{d'} H_{\mu \nu} = \frac{1}{2 g} V_{a c} \varepsilon ^{c c'} U_{d b} \varepsilon ^{d d'} G_{\mu \nu}
\end{equation*}
\begin{equation*}
    H_{\mu \nu} = - \frac{1}{8 g} U_{a c} \varepsilon ^{c a} V_{d b} \varepsilon ^{b d} G_{\mu \nu}
\end{equation*}
\begin{equation*}
    H_{\mu \nu} = - \frac{1}{8 g} \Tr (U \varepsilon) \Tr (V \varepsilon) G_{\mu \nu} ,
\end{equation*}
where we must impose that $\Tr (U \varepsilon) \Tr (V \varepsilon) = - 8$ to recover the NG area corrected action.
