...
\begin{equation*}
    X^{\mu} (\tau , \sigma) = \sum _{n \in \mathbb{Z}} \frac{1}{2 E_{n}} \left( a^{\mu} _{n} \e ^{i (E_{n} \tau - n \sigma)} + b^{\mu} _{n} \e ^{- i (E_{n} \tau - n \sigma)} \right) ,
\end{equation*}
with $E_{n} = \sqrt{n^2 + m^2}$.

Reality of $X^{\mu}$ implies
\begin{align*}
    (X^{\mu})^{*} & = \left( \sum _{n \in \mathbb{Z}} \frac{1}{2 E_{n}} \left( a^{\mu} _{n} \e ^{i (E_{n} \tau - n \sigma)} + b^{\mu} _{n} \e ^{- i (E_{n} \tau - n \sigma)} \right) \right) ^{*} =        \\
                  & = \sum _{n \in \mathbb{Z}} \frac{1}{2 E_{n}} \left( (a^{\mu} _{n})^{*} \e ^{- i (E_{n} \tau - n \sigma)} + (b^{\mu} _{n})^{*} \e ^{i (E_{n} \tau - n \sigma)} \right) \equiv X^{\mu} ,
\end{align*}
giving us
\begin{align*}
    (a^{\mu} _{n})^{*} & = b^{\mu} _{n}   \\
...
\begin{equation*}
    X^{\mu} = \sum _{n} \frac{1}{2 E_{n}} \left( a^{\mu} _{n} \e ^{i (E_{n} \tau - n \sigma)} + (a^{\mu} _{n})^{*} \e ^{- i (E_{n} \tau - n \sigma)} \right) .
\end{equation*}

Analysing the constraints, for the closed string we have the derivatives
\begin{align*}
    \partial _{\tau} X^{\mu}   & = \frac{i}{2} \sum _{n} \left( a^{\mu} _{n} \e ^{i (E_{n} \tau - n \sigma)} - (a^{\mu} _{n})^{*} \e ^{- i (E_{n} \tau - n \sigma)} \right)                     \\
    \partial _{\sigma} X^{\mu} & = - \frac{i}{2} \sum _{n} \frac{n}{E_{n}} \left( a^{\mu} _{n} \e ^{i (E_{n} \tau - n \sigma)} - (a^{\mu} _{n})^{*} \e ^{- i (E_{n} \tau - n \sigma)} \right) ,
\end{align*}
\begin{equation*}
    \partial _{\tau} X^{\mu} \pm \partial _{\sigma} X^{\mu} = \frac{i}{2} \sum _{n} \left( 1 \mp \frac{n}{E_{n}} \right) \left( a^{\mu} _{n} \e ^{i (E_{n} \tau - n \sigma)} - (a^{\mu} _{n})^{*} \e ^{- i (E_{n} \tau - n \sigma)} \right)
\end{equation*}
so the constraint reads
\begin{multline*}
    (\partial _{\tau} X \pm \partial _{\sigma} X)^2 = - \frac{\eta _{\mu \nu}}{4} \sum _{n} \sum _{p} \left( 1 \mp \frac{n}{E_{n}} \right) \left( 1 \mp \frac{p}{E_{p}} \right) \bigg( a^{\mu} _{n} a^{\nu} _{p} \e ^{i (E_{n} + E_{p}) \tau} \e ^{- i (n + p) \sigma} - \\
...
\end{align*}
so we get that $c_{2} = 1 / (2 c_{1})$, and the 0-th mode becomes $\alpha ^{\mu} _{0} = c_{1} \mu x^{\mu} + i p^{\mu} / (2 c_{1})$.

\subsection{The Constraint Algebra}

With the bracket relations between the vibrational modes in hand, we can now calculate the algebra generated by the constraints. For simplicity, since $E_{n} = \sqrt{n^2 + \mu ^2} \neq 0$, we can switch the constraints to be between the normalized harmonic oscillator modes $a^{\mu} _{n}$ instead of the $\alpha ^{\mu} _{n}$.
\begin{equation*}
