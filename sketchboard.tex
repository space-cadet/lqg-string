...
\end{equation*}
\begin{equation*}
    \frac{1}{2 \pi} \int _{0} ^{2 \pi} \diff \sigma ' F^{-} \e ^{i (p + m) \sigma '} , \ F^{-} = 1 - \frac{k \Delta}{2 \phi ^2} , \ \phi = \phi (\tau , \sigma ') , \ \mathrm{assume} \ \phi = cte
\end{equation*}
\begin{multline*}
...
\end{align*}
One curious thing has happened: since $a^{\mu} _{0}$ is purely imaginary, we have that
\begin{equation*}
    - i \eta ^{\mu \nu} = \left\{ a^{\mu} _{0} , (a^{\nu} _{0})^{*} \right\} = \left\{ a^{\mu} _{0} , - a^{\nu} _{0} \right\} = - \left\{ a^{\mu} _{0} , a^{\nu} _{0} \right\} \propto \left\{ p^{\mu} , p^{\nu} \right\} ,
\end{equation*}
so we see that the momentum $p^{\mu}$ is a non-self-commuting quantity, indicating we're dealing with a superalgebra.
