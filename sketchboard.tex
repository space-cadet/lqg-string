...
\end{equation*}
\begin{equation*}
    \eta ^{a b} \left( \delta ^{I} _{J} \partial _{a} \partial _{b} + 2 k \mc{A}^{I} _{a J} \partial _{b} \right) X^{J} = - \left( k \eta ^{a b} \partial _{a} \mc{A}^{I} _{a J} X^{J} + k^2 \eta ^{a b} \mc{A}^{I} _{a I'} \mc{A}^{I'} _{b J} X^{J} \right) ,
\end{equation*}
...
\begin{equation*}
    \diff s^2 = - \left( 1 - \frac{r_{s} ^{d - 2}}{r^{d - 2}} \right) \diff t^2 + \frac{1}{1 - \dfrac{r_{s} ^{d - 2}}{r^{d - 2}}} \diff r^2 + r^2 \diff \Omega _{d - 1} ^2
\end{equation*}
