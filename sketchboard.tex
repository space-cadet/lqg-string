...
\end{equation*}
\begin{equation*}
    \Lagr = - \frac{T_{0}}{2} \det (e) \eta ^{i j} e^{a} _{i} e^{b} _{j} D_{a} X^{\mu I} D_{b} X^{\nu J} E_{\mu} ^{K} E_{\nu K} \eta _{I J}
\end{equation*}
...
\end{equation*}
\begin{equation*}
    \Lagr = - \frac{T_{0}}{2} \det (e) e^{a} _{i} e^{b} _{j} D_{a} X^{\mu i} D_{b} X^{\mu j} E_{\mu} ^{I} (X) E_{\nu I} (X)
\end{equation*}
...
\end{equation*}
\begin{equation*}
    \Lagr = - \frac{T_{0}}{2} \det (e) e^{a} _{i} e^{b i} \partial _{a} X^{\mu} \partial _{b} X^{\nu} E_{\mu} ^{I} (X) E_{\nu I} (X) \ .
\end{equation*}
...
\begin{align*}
    \frac{\delta S}{\delta e^{e} _{l}} & = \frac{D \Lagr}{D e^{e} _{l}} = \left( \frac{\partial}{\partial e^{e} _{l}} - \partial _{f} \frac{\partial}{\partial (\partial _{f} e^{e} _{l})} \right) \left( - \frac{T_{0}}{2} \frac{1}{2} \varepsilon ^{c d} \varepsilon _{m n} e^{m} _{c} e^{n} _{d} \eta ^{i j} e^{a} _{i} e^{b} _{j} \partial _{a} X^{\mu} \partial _{b} X^{\nu} E^{I} _{\mu} E^{J} _{\nu} \eta _{I J} \right) = \\
                                       & = - \frac{T_{0}}{4}
\end{align*}
