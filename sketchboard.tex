...
\begin{align*}
    \Big[ \Hat{L}_{n , m} , \Hat{\widetilde{L}}_{p , k} \Big] & = \Big[ \frac{m - n}{E_{m - n}} \Hat{\alpha}^{\mu} _{n} \Hat{\alpha}^{\nu} _{n - m} \eta _{\mu \nu} , \frac{k - p}{E_{k - p}} (\Hat{\alpha}^{\mu '} _{k})^{\dagger} \Hat{\alpha}^{\nu '} _{k - p} \eta _{\mu ' \nu '} \Big] =                                                                                                                                                                                                \\
                                                              ...
                                                              & = \frac{(m - n)}{E_{m - n}} \frac{(k - p)}{E_{k - p}} \eta _{\mu \nu} \left( \delta _{n - m , k} \Hat{\alpha}^{\mu} _{n} + \delta _{n , k} \Hat{\alpha}^{\mu} _{n - m} \right) \Hat{\alpha}^{\nu} _{k - p} =                                                                                                                                                                                                                 \\
                                                              & = \frac{(m - n)}{E_{m - n}} \frac{(k - p)}{E_{k - p}} \eta _{\mu \nu} \left( \delta _{n - m , k} \Hat{a}^{\mu} _{n} + \delta _{n , k} \Hat{a}^{\mu} _{n - m} \right) \Hat{a}^{\nu} _{k - p}
\end{align*}
\begin{align*}
    \Big[ \Hat{\widetilde{L}}_{n , m} , \Hat{\widetilde{L}}_{p , k} \Big] & = \Big[ \frac{(m - n)}{E_{m - n}} (\Hat{\alpha}^{\mu} _{n})^{\dagger} \Hat{\alpha}^{\nu} _{n - m} \eta _{\mu \nu} , \frac{(k - p)}{E_{k - p}} (\Hat{\alpha}^{\mu '} _{k})^{\dagger} \Hat{\alpha}^{\nu '} _{k - p} \eta _{\mu ' \nu '} \Big] =                                                                                                                                                                    \\
                                                                          ...
                                                                          & = \frac{(m - n)}{E_{m - n}} \frac{(k - p)}{E_{k - p}} \eta _{\mu \nu} \left( (\Hat{a}^{\mu} _{- n})^{\dagger} \Hat{a}^{\nu} _{k - p} \delta _{n - m , k} + (\Hat{a}^{\mu} _{- k})^{\dagger} \Hat{a}^{\nu} _{n - m} \delta _{n , k - p} \right) .
\end{align*}
Note how in both non-vanishing commutators, the annihilation operator always end up on the right. Note also that $(\Hat{\widetilde{L}}_{n , p})^{\dagger} = \frac{(p - n)}{E_{p - n}} \frac{E_{n}}{(- n)} \Hat{\widetilde{L}}_{n - p , - p}$ thus if we have a sequence of $L$'s sandwiched between physical states (where if one of the $p$'s is 0 the $\widetilde{L}$ should be replaced by $\widetilde{L} - a$)
\begin{equation*}
    \bra{\mathrm{phys}'} L_{n_1 , p_1} ... L_{n_m , p_k} \ket{\mathrm{phys}}
\end{equation*}
\begin{equation*}
    \bra{\mathrm{phys}'}
\end{equation*}
