...
\begin{align*}
    X^{\mu} (\tau , \sigma) = \frac{a_{0}}{2 \pi} \int \diff p \frac{1}{2 E (p)} \left( \Lambda ^{\mu} _{\ +} \left( \frac{p}{4} \right) \e ^{- i (- E \tau + p \sigma)} + \frac{b_{0}}{a_{0}} \Lambda ^{\mu} _{\ +} \left( - \frac{p}{4} \right) \e ^{i (- E \tau + p \sigma)} \right) x^{+}
\end{align*}
