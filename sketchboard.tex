...
\section{Klein-Gordon String Action}

Regular string EoM is a wave eqn, so promote to KG eqn from quantum geometry effects
\begin{equation*}
    (\del _{\sigma})^2 X^{\mu} - (\del _{\tau})^2 X^{\mu} + \mu ^2 X^{\mu} = 0 ,
\end{equation*}
which can be achieved by the action
\begin{equation*}
    S = - \frac{T}{2} \int \diff ^2 x \sqrt{- g} \left( g^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} \eta _{\mu \nu} - \mu ^2 X^{\mu} X^{\nu} \eta _{\mu \nu} \right) .
\end{equation*}
This action has manifest Lorentz invariance, but not translation invariance. This is fine since the string is not propagating in a vacuum. It also has WS Weyl symmetry.

\subsection{EoMs}

\begin{align*}
    \frac{\delta S}{\delta g^{c d}} & \propto \frac{\del \sqrt{- g}}{\del g^{c d}} \left( g^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} \eta _{\mu \nu} - \mu ^2 X^{\mu} X^{\nu} \eta _{\mu \nu} \right) + \sqrt{- g} \delta ^{a} _{c} \delta ^{b} _{d} \partial _{a} X^{\mu} \partial _{b} X^{\nu} \eta _{\mu \nu} = \\
                                    & = - \frac{1}{2} \sqrt{- g} g_{c d} \left( g^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} \eta _{\mu \nu} - \mu ^2 X^{\mu} X^{\nu} \eta _{\mu \nu} \right) + \sqrt{- g} \partial _{c} X^{\mu} \partial _{d} X^{\nu} \eta _{\mu \nu} = 0
\end{align*}
\begin{equation*}
    T_{c d} := \partial _{c} X^{\mu} \partial _{d} X^{\nu} \eta _{\mu \nu} - \frac{1}{2} g_{c d} \left( g^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} \eta _{\mu \nu} - \mu ^2 X^{\mu} X^{\nu} \eta _{\mu \nu} \right) = 0
\end{equation*}
\begin{equation*}
    g_{c d} = 2 f \partial _{c} X^{\mu} \partial _{d} X^{\nu} \eta _{\mu \nu} ,
\end{equation*}
\begin{equation*}
    \frac{1}{f} = \left( g^{a b} \partial _{a} X^{\mu} \partial _{b} X^{\nu} \eta _{\mu \nu} - \mu ^2 X^{\mu} X^{\nu} \eta _{\mu \nu} \right) .
\end{equation*}
This implies $X^{\mu} X^{\nu} \eta _{\mu \nu} = 0$, so the string coordinates are on the light-cone and the auxiliary metric coincides with the induced metric, thus the action reduces back to regular NG action after imposing this EoM.

\begin{align*}
    \frac{\delta S}{\delta X^{\lambda}} & \propto - 2 \sqrt{- g} \mu ^2 X^{\mu} \delta ^{\nu} _{\lambda} \eta _{\mu \nu} - 2 \del _{c} \left( \sqrt{- g} g^{a b} \delta ^{c} _{a} \delta ^{\mu} _{\lambda} \del _{b} X^{\nu} \eta _{\mu \nu} \right) = \\
                                        & = - 2 \sqrt{- g} \mu ^2 X^{\mu} \eta _{\lambda} - 2 \del _{a} \left( \sqrt{- g} g^{a b} \del _{b} X^{\mu} \eta _{\mu \lambda} \right) = 0
\end{align*}
\begin{equation*}
    \del _{a} \left( \sqrt{- g} g^{a b} \del _{b} X^{\mu} \right) + \sqrt{- g} \mu ^2 X^{\mu} = 0
\end{equation*}
\begin{equation*}
    \frac{1}{\sqrt{- g}} \del _{a} \left( \sqrt{- g} g^{a b} \del _{b} X^{\mu} \right) + \mu ^2 X^{\mu} = 0
\end{equation*}
\begin{equation*}
    g^{a b} \nabla _{a} \nabla _{b} X^{\mu} + \mu ^2 X^{\mu} = 0
\end{equation*}
...
\begin{align*}
    ...
    (b^{\mu} _{n})^{*} & = a^{\mu} _{n} ,
\end{align*}
and also that actually only the $\cos (E_{n} \tau)$ is used, so the solution becomes for closed strings
\begin{equation*}
    X^{\mu} (\tau , \sigma) = \frac{1}{2 \pi \alpha '} \sum _{n \in \mathbb{Z}} \frac{1}{2 E_{n}} \left( a^{\mu} _{n} \e ^{- i n \sigma} + (a^{\mu} _{n})^{*} \e ^{i n \sigma} \right) \cos (E_{n} \tau) .
\end{equation*}
For open strings with free endpoints B.C we have general solution
\begin{equation*}
    X^{\mu} (\tau , \sigma) = \frac{1}{2 \pi \alpha '} \sum _{n \in \mathbb{Z}} \frac{1}{2 E_{n}} a^{\mu} _{n} \cos (E_{n} \tau) \cos (n \sigma) .
\end{equation*}

Analysing the constraints, for the closed string we have the derivatives
\begin{align*}
    \partial _{\tau} X^{\mu}   & = - \frac{1}{4 \pi \alpha '} \sum _{n} \left( a^{\mu} _{n} \e ^{- i n \sigma} + (a^{\mu} _{n})^{*} \e ^{i n \sigma} \right) \sin (E_{n} \tau)                   \\
    \partial _{\sigma} X^{\mu} & = \frac{i}{4 \pi \alpha '} \sum _{n} \frac{n}{E_{n}} \left( - a^{\mu} _{n} \e ^{- i n \sigma} + (a^{\mu} _{n})^{*} \e ^{i n \sigma} \right) \cos (E_{n} \tau) ,
\end{align*}
\begin{equation*}
    \partial _{\tau} X^{\mu} \pm \partial _{\sigma} X^{\mu} = \frac{1}{4 \pi \alpha '} \sum _{n} \bigg( - a^{\mu} _{n} \bigg( \sin (E_{n} \tau) \pm i \frac{n}{E_{n}} \cos (E_{n} \tau) \bigg) \e ^{- i n \sigma} + (a^{\mu} _{n})^{*} \bigg( - \sin (E_{n} \tau) \pm i \frac{n}{E_{n}} \cos (E_{n} \tau) \bigg) \e ^{i n \sigma} \bigg)
\end{equation*}
so the constraint reads
\begin{multline*}
    (\partial _{\tau} X \pm \partial _{\sigma} X)^2 = \frac{\eta _{\mu \nu}}{(4 \pi \alpha ')^2} \sum _{n} \sum _{p} \bigg( a^{\mu} _{n} a^{\nu} _{p} \bigg( \sin (E_{n} \tau) \pm i \frac{n}{E_{n}} \cos (E_{n} \tau) \bigg) \bigg( \sin (E_{p} \tau) \pm i \frac{p}{E_{p}} \cos (E_{p} \tau) \bigg) \e ^{- i (n + p) \sigma} - \\
    - a^{\mu} _{n} (a^{\nu} _{p})^{*} \bigg( \sin (E_{n} \tau) \pm i \frac{n}{E_{n}} \cos (E_{n} \tau) \bigg) \bigg( - \sin (E_{p} \tau) \pm i \frac{p}{E_{p}} \cos (E_{p} \tau) \bigg) \e ^{- i (n - p) \sigma} - \\
    - (a^{\mu} _{n})^{*} a^{\nu} _{p} \bigg( - \sin (E_{n} \tau) \pm i \frac{n}{E_{n}} \cos (E_{n} \tau) \bigg) \bigg( \sin (E_{p} \tau) \pm i \frac{p}{E_{p}} \cos (E_{p} \tau) \bigg) \e ^{i (n - p) \sigma} + \\
    + (a^{\mu} _{n})^{*} (a^{\nu} _{p})^{*} \bigg( - \sin (E_{n} \tau) \pm i \frac{n}{E_{n}} \cos (E_{n} \tau) \bigg) \bigg( - \sin (E_{p} \tau) \pm i \frac{p}{E_{p}} \cos (E_{p} \tau) \bigg) \e ^{i (n + p) \sigma} \bigg) \equiv 0
\end{multline*}
...
To make it more in line with regular ST literature, let's also map $p \mapsto p - n$:
\begin{align*}
    L_{n , p} = a^{\mu} _{n} a^{\nu} _{p - n} \eta _{\mu \nu}                                           & = 0   \\
    \widetilde{L}_{n , p} = a^{\mu} _{n} (a^{\nu} _{n - p})^{*} \eta _{\mu \nu}                         & = 0   \\
    \sum _{n} \left( \left( \left( \frac{n}{E_{n}} \right) ^2 - 1 \right) \widetilde{L}_{n , 0} \right) & = 0 .
\end{align*}
...
\end{equation*}
which is divergent in the $m \rightarrow 0$ limit unless $\mathfrak{Re}(a^{\mu} _{0}) = 0$, thus $a^{\mu} _{0}$ must be purely imaginary. Keeping the analogy to the $m \rightarrow 0$ regime, we conclude $a^{\mu} _{0} = 4 \pi i (\alpha ')^2 p^{\mu}$. Since $a^{\mu} _{0}$ is proportional to $p^{\mu}$, we have that
\begin{equation*}
    M^2 = - p^{\mu} p_{\mu} = \frac{1}{16 \pi ^2 (\alpha ')^4} a^{\mu} _{0} a^{\nu} _{0} \eta _{\mu \nu} ,
\end{equation*}
...
\end{equation*}
\begin{equation*}
    \sum _{n \neq 0} \left( \left( \left( \frac{n}{E_{n}} \right) ^2 - 1 \right) \widetilde{L}_{n , 0} \right) - \widetilde{L}_{0 , 0} = 0
\end{equation*}
\begin{equation*}
    \sum _{n \neq 0} \left( \left( \left( \frac{n}{E_{n}} \right) ^2 - 1 \right) \widetilde{L}_{n , 0} \right) = a^{\mu} _{0} (a^{\nu} _{0})^{*} \eta _{\mu \nu} \equiv (4 \pi (\alpha ')^2)^2 p^{\mu} p_{\mu} ,
\end{equation*}
we have the string mass in terms of vibrational modes
\begin{align*}
    M^2 & = - \frac{1}{(4 \pi (\alpha ')^2)^2} \sum _{n \neq 0} \left( \left( \left( \frac{n}{E_{n}} \right) ^2 - 1 \right) \widetilde{L}_{n , 0} \right) =                           \\
        & = - \frac{1}{(4 \pi (\alpha ')^2)^2} \sum _{n \neq 0} \left( \left( \left( \frac{n}{E_{n}} \right) ^2 - 1 \right) a^{\mu} _{n} (a^{\nu} _{n})^{*} \eta _{\mu \nu} \right) .
\end{align*}
However, since
\begin{equation*}
    L_{n , p} = 0 , \ \forall \ n , p \in \mathbb{Z} ,
\end{equation*}
in particular we have $L_{0 , 0} = a^{\mu} _{0} a^{\nu} _{0} \eta _{\mu \nu} = 0$, thus the center of mass momentum $p^{\mu}$ is a null vector.
...
\end{equation*}
where $F^{-} = \sum _{l} (A_{l} \e ^{i (E_{l} \tau + l \sigma)} + (A_{- l})^{*} \e ^{i (- E_{l} \tau + l \sigma)})$. We then proceed to the canonical Poisson bracket relations
\begin{equation*}
    \left\{ X^{\mu} (\tau , \sigma) , \Pi ^{\nu} (\tau ' , \sigma ') \right\} = \delta (\tau - \tau ') \delta (\sigma - \sigma ') \eta ^{\mu \nu}
\end{equation*}
\begin{equation*}
...
\begin{multline*}
    ...
    F^{-} (\tau ' , \sigma ') \frac{i}{4 \pi \alpha '} \sum _{p \in \mathbb{Z}} \left( - \alpha ^{\nu} _{p} \e ^{i (- E_{p} \tau ' + p \sigma ')} + (\alpha ^{\nu} _{- p})^{*} \e ^{i (E_{p} \tau ' + p \sigma ')} \right) \bigg\} = \delta (\tau - \tau ') \delta (\sigma - \sigma ') \eta ^{\mu \nu}
\end{multline*}
\begin{multline*}
    \frac{i}{8 \pi ^2 (\alpha ')^2} \sum _{n} \sum _{p} \frac{1}{2 E_{n}} F^{-} (\tau ' , \sigma ') \bigg\{ \left( \alpha ^{\mu} _{n} \e ^{i (- E_{n} \tau + n \sigma)} + (\alpha ^{\mu} _{- n})^{*} \e ^{i (E_{n} \tau + n \sigma)} \right) , \\
    \left( - \alpha ^{\nu} _{p} \e ^{i (- E_{p} \tau ' + p \sigma ')} + (\alpha ^{\nu} _{- p})^{*} \e ^{i (E_{p} \tau ' + p \sigma ')} \right) \bigg\} = \delta (\tau - \tau ') \delta (\sigma - \sigma ') \eta ^{\mu \nu}
\end{multline*}
\begin{multline*}
    \frac{i}{8 \pi ^2 (\alpha ')^2} \sum _{n} \sum _{p} \frac{F^{-} (\tau ' , \sigma ')}{2 E_{n}} \bigg( - \left\{ \alpha ^{\mu} _{n} , \alpha ^{\nu} _{p} \right\} \e ^{- i E_{n} \tau} \e ^{- i E_{p} \tau '} \e ^{i n \sigma} \e ^{i p \sigma '} + \left\{ \alpha ^{\mu} _{n} , (\alpha ^{\nu} _{- p})^{*} \right\} \e ^{- i E_{n} \tau} \e ^{i E_{p} \tau '} \e ^{i n \sigma} \e ^{i p \sigma '} - \\
    - \left\{ (\alpha ^{\mu} _{- n})^{*} , \alpha ^{\nu} _{p} \right\} \e ^{i E_{n} \tau} \e ^{- i E_{p} \tau '} \e ^{i n \sigma} \e ^{i p \sigma '} + \left\{ (\alpha ^{\mu} _{- n})^{*} , (\alpha ^{\nu} _{- p})^{*} \right\} \e ^{i E_{n} \tau} \e ^{i E_{p} \tau '} \e ^{i n \sigma} \e ^{i p \sigma '} \bigg) = \delta (\tau - \tau ') \delta (\sigma - \sigma ') \eta ^{\mu \nu}
\end{multline*}
\begin{equation*}
    \Bigg\downarrow \frac{1}{2 \pi} \int _{0} ^{2 \pi} \diff \sigma \e ^{- i m \sigma}
\end{equation*}
\begin{multline*}
    \frac{i}{8 \pi ^2 (\alpha ')^2} \sum _{p} \frac{F^{-} (\tau ' , \sigma ')}{2 E_{m}} \bigg( - \left\{ \alpha ^{\mu} _{m} , \alpha ^{\nu} _{p} \right\} \e ^{- i E_{m} \tau} \e ^{- i E_{p} \tau '} \e ^{i p \sigma '} + \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{- p})^{*} \right\} \e ^{- i E_{m} \tau} \e ^{i E_{p} \tau '} \e ^{i p \sigma '} - \\
    - \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{p} \right\} \e ^{i E_{m} \tau} \e ^{- i E_{p} \tau '} \e ^{i p \sigma '} + \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{- p})^{*} \right\} \e ^{i E_{m} \tau} \e ^{i E_{p} \tau '} \e ^{i p \sigma '} \bigg) = \frac{1}{2 \pi} \delta (\tau - \tau ') \e ^{- i m \sigma '} \eta ^{\mu \nu}
\end{multline*}
\begin{equation*}
    \Bigg\downarrow \frac{1}{2 \pi} \int _{0} ^{2 \pi} \diff \sigma ' \e ^{i k \sigma '}
\end{equation*}
\begin{equation*}
    \frac{1}{2 \pi} \int _{0} ^{2 \pi} \diff \sigma ' F^{-} \e ^{i (k + p) \sigma '} , \ F^{-} = \sum _{l} \left( A_{l} \e ^{i (E_{l} \tau ' + l \sigma ')} + (A_{- l})^{*} \e ^{i (- E_{l} \tau ' + l \sigma ')} \right)
\end{equation*}
\begin{multline*}
    \frac{i}{16 \pi ^2 (\alpha ')^2 E_{m}} \sum _{l} \left( A_{l} \e ^{i E_{l} \tau '} + (A_{- l})^{*} \e ^{- i E_{l} \tau '} \right) \bigg( - \left\{ \alpha ^{\mu} _{m} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{- i E_{m} \tau} \e ^{- i E_{k + l} \tau '} + \\
    + \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{- i E_{m} \tau} \e ^{i E_{k + l} \tau '} - \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i E_{m} \tau} \e ^{- i E_{k + l} \tau '} + \\
    + \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{i E_{m} \tau} \e ^{i E_{k + l} \tau '} \bigg) = \frac{1}{2 \pi} \delta (\tau - \tau ') \delta _{k , m} \eta ^{\mu \nu}
\end{multline*}
\begin{multline*}
    \frac{i}{16 \pi ^2 (\alpha ')^2 E_{m}} \sum _{l} \bigg( - A_{l} \left\{ \alpha ^{\mu} _{m} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{- i E_{m} \tau} \e ^{- i (E_{k + l} + E_{l}) \tau '} + A_{l} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{- i E_{m} \tau} \e ^{i (E_{k + l} + E_{l}) \tau '} - \\
    - A_{l} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i E_{m} \tau} \e ^{- i (E_{k + l} - E_{l}) \tau '} + A_{l} \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{i E_{m} \tau} \e ^{i (E_{k + l} + E_{l}) \tau '} - \\
    - (A_{- l})^{*} \left\{ \alpha ^{\mu} _{m} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{- i E_{m} \tau} \e ^{- i (E_{k + l} + E_{l}) \tau '} + (A_{- l})^{*} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{- i E_{m} \tau} \e ^{i (E_{k + l} - E_{l}) \tau '} - \\
    - (A_{- l})^{*} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i E_{m} \tau} \e ^{- i (E_{k + l} - E_{l}) \tau '} + \\
    + (A_{- l})^{*} \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{i E_{m} \tau} \e ^{i (E_{k + l} - E_{l}) \tau '} \bigg) = \frac{1}{2 \pi} \delta (\tau - \tau ') \delta _{k , m} \eta ^{\mu \nu}
\end{multline*}
\begin{equation*}
    \Bigg\downarrow \frac{1}{2 \pi} \int _{- \tau} ^{\tau} \diff \tau ' \e ^{- i E_{m} \tau '}
\end{equation*}
\begin{multline*}
    \frac{i}{16 \pi ^2 (\alpha ')^2 E_{m}} \sum _{l} \bigg( - A_{l} \left\{ \alpha ^{\mu} _{m} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{- i E_{m} \tau} \delta _{E_{k + l} + E_{l} - E_{m} , 0} + A_{l} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{- i E_{m} \tau} \delta _{E_{k + l} + E_{l} - E_{m} , 0} - \\
    - A_{l} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i E_{m} \tau} \delta _{E_{k + l} - E_{l} - E_{m} , 0} + A_{l} \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{i E_{m} \tau} \delta _{E_{k + l} + E_{l} - E_{m} , 0} - \\
    - (A_{- l})^{*} \left\{ \alpha ^{\mu} _{m} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{- i E_{m} \tau} \delta _{E_{k + l} + E_{l} - E_{m} , 0} + (A_{- l})^{*} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{- i E_{m} \tau} \delta _{E_{k + l} - E_{l} - E_{m} , 0} - \\
    - (A_{- l})^{*} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i E_{m} \tau} \delta _{E_{k + l} - E_{l} - E_{m} , 0} + \\
    + (A_{- l})^{*} \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{i E_{m} \tau} \delta _{E_{k + l} - E_{l} - E_{m} , 0} \bigg) = \frac{1}{(2 \pi)^{2}} \e ^{- i E_{m} \tau} \delta _{k , m} \eta ^{\mu \nu}
\end{multline*}
...
\end{equation*}
\begin{equation*}
    = \frac{1}{4 \pi \alpha '} F^{-} \partial _{\tau} X^{\nu} \eta_{\lambda \nu} = F^{-} \frac{i}{(4 \pi \alpha ')^2} \sum _{p} \left( - \alpha ^{\nu} _{p} \e ^{i (- E_{p} \tau + p \sigma)} + (\alpha ^{\nu} _{- p})^{*} \e ^{i (E_{p} \tau + p \sigma)} \right) \eta _{\nu \lambda} .
\end{equation*}
