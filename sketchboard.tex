...
\end{equation*}
where $T$ is the temperature of target-space, $\mu _{0}$ has units of mass (perhaps $\mu _{0} \sim M_{pl}$ or $\mu _{0} ^{2} \sim (\mathrm{quantum \ of \ area})^{-1}$?) and $m_{0} >> m_{1} >> ... >> m_{d}$. The masses $m_{\mu}$ are constrained by the dispersion relation
\begin{equation*}
    E_{\mu} ^{2} = p_{\mu} ^2 + \sum _{n = 0} ^{D} m_{n} ^2 \frac{p^{n}}{E_{pl} ^{n}}
\end{equation*}
where $E_{\mu} ^2$ does not mean $E^{\mu} E_{\mu}$, rather it is $(E_{0})^{2} , (E_{1})^2 , ... , (E_{d})^2$, that is, the squared WS energy (and momentum) of each field $X^{\mu}$. This action has manifest Lorentz invariance and WS reparameterisation and Weyl invariance. As for translational symmetry, it holds approximately for the fields with $m_{\mu} >> T$.
