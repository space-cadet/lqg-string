...
\begin{equation*}
    X^{\mu} = \frac{1}{2 \pi \alpha '} \sum _{n} \frac{1}{2 E_{n}} \left( a^{\mu} _{n} \e ^{i (E_{n} \tau - n \sigma)} + (a^{\mu} _{n})^{*} \e ^{- i (E_{n} \tau - n \sigma)} \right) .
\end{equation*}

Analysing the constraints, for the closed string we have the derivatives
\begin{align*}
    \partial _{\tau} X^{\mu}   & = \frac{i}{4 \pi \alpha '} \sum _{n} \left( a^{\mu} _{n} \e ^{i (E_{n} \tau - n \sigma)} - (a^{\mu} _{n})^{*} \e ^{- i (E_{n} \tau - n \sigma)} \right)                     \\
    \partial _{\sigma} X^{\mu} & = - \frac{i}{4 \pi \alpha '} \sum _{n} \frac{n}{E_{n}} \left( a^{\mu} _{n} \e ^{i (E_{n} \tau - n \sigma)} - (a^{\mu} _{n})^{*} \e ^{- i (E_{n} \tau - n \sigma)} \right) ,
\end{align*}
\begin{equation*}
    \partial _{\tau} X^{\mu} \pm \partial _{\sigma} X^{\mu} = \frac{i}{4 \pi \alpha '} \sum _{n} \left( 1 \mp \frac{n}{E_{n}} \right) \left( a^{\mu} _{n} \e ^{i (E_{n} \tau - n \sigma)} - (a^{\mu} _{n})^{*} \e ^{- i (E_{n} \tau - n \sigma)} \right)
\end{equation*}
so the constraint reads
\begin{multline*}
    (\partial _{\tau} X \pm \partial _{\sigma} X)^2 = - \frac{\eta _{\mu \nu}}{(4 \pi \alpha ')^2} \sum _{n} \sum _{p} \left( 1 \mp \frac{n}{E_{n}} \right) \left( 1 \mp \frac{p}{E_{p}} \right) \bigg( a^{\mu} _{n} a^{\nu} _{p} \e ^{i (E_{n} + E_{p}) \tau} \e ^{- i (n + p) \sigma} - \\
...
\end{equation*}
which is divergent in the $m \rightarrow 0$ limit unless $\mathfrak{Re}(a^{\mu} _{0}) \sim m$. Keeping the analogy to the $m \rightarrow 0$ regime, we conclude $a^{\mu} _{0} = 2 \pi \alpha ' m x^{\mu} + 4 \pi i (\alpha ')^2 p^{\mu}$. We also have that
\begin{equation*}
    M^2 = - p^{\mu} p_{\mu} = \frac{1}{16 \pi ^2 (\alpha ')^4} (a^{\mu} _{0} a^{\nu} _{0} - (2 \pi \alpha ' m)^2 x^{\mu} x^{\nu}) \eta _{\mu \nu} ,
\end{equation*}
...
\end{equation*}
\begin{equation*}
    \sum _{n \neq 0} \left( \left( 1 \mp \frac{n}{E_{n}} \right) ^2 \widetilde{L}_{n , n} \right) = a^{\mu} _{0} (a^{\nu} _{0})^{*} \eta _{\mu \nu} \equiv (2 \pi \alpha ' m)^2 x^{\mu} x_{\mu} + (4 \pi (\alpha ')^2)^2 p^{\mu} p_{\mu} ,
\end{equation*}
we have the string mass in terms of vibrational modes and center of mass position
\begin{align*}
    M^2 & = - \frac{1}{(4 \pi (\alpha ')^2)^2} \left( \sum _{n \neq 0} \left( \left( 1 \mp \frac{n}{E_{n}} \right) ^2 \widetilde{L}_{n , n} \right) - (2 \pi \alpha ' m)^2 x^{\mu} x_{\mu} \right) =                           \\
        & = - \frac{1}{(4 \pi (\alpha ')^2)^2} \left( \sum _{n \neq 0} \left( \left( 1 \mp \frac{n}{E_{n}} \right) ^2 a^{\mu} _{n} (a^{\nu} _{n})^{*} \eta _{\mu \nu} \right) - (2 \pi \alpha ' m)^2 x^{\mu} x_{\mu} \right) .
\end{align*}
...
\begin{multline*}
    \left\{ X^{\mu} (0 , \sigma) , \Pi ^{\nu} (0 , \sigma ') \right\} = \bigg\{ \frac{1}{4 \pi \alpha '} \sum _{n} \frac{1}{E_{n}} \left( \alpha ^{\mu} _{n} \e ^{- i n \sigma} + (\alpha ^{\mu} _{n})^{*} \e ^{i n \sigma} \right) , \\
    \frac{i}{(4 \pi \alpha ')^{2}} F^{-} (0 , \sigma ') \sum _{p} \left( \alpha ^{\nu} _{p} \e ^{- i p \sigma '} - (\alpha ^{\nu} _{p})^{*} \e ^{i p \sigma '} \right) \bigg\} = \delta (\sigma - \sigma ') \eta ^{\mu \nu}
\end{multline*}
\begin{multline*}
    \frac{i}{(4 \pi \alpha ')^3} F^{-} (0 , \sigma ') \sum _{n} \frac{1}{E_{n}} \sum _{p} \bigg( \left\{ \alpha ^{\mu} _{n} , \alpha ^{\nu} _{p} \right\} \e ^{- i n \sigma} \e ^{- i p \sigma '} - \left\{ \alpha ^{\mu} _{n} , (\alpha ^{\nu} _{p})^{*} \right\} \e ^{- i n \sigma} \e ^{i p \sigma '} + \\
...
\end{align*}
thus we rescale the vibrational modes to get harmonic oscillator bracket relations
\begin{align*}
...
\begin{equation*}
    \left\{ \alpha ^{\mu} _{0} , (\alpha ^{\nu} _{0})^{*} \right\} = \left\{ (2 \pi \alpha ' \mu x^{\mu} + i 4 \pi (\alpha ')^2 p^{\mu}) , (2 \pi \alpha ' \mu x^{\nu} - i 4 \pi (\alpha ')^2 p^{\nu}) \right\} = - i \mu \eta ^{\mu \nu}
\end{equation*}
\begin{equation*}
    (2 \pi \alpha ' \mu)^2 \left\{ x^{\mu} , x^{\nu} \right\} + (4 \pi (\alpha ')^2)^{2} \left\{ p^{\mu} , p^{\nu} \right\} - i 8 \pi ^2 (\alpha ')^3 \mu \left( \left\{ x^{\mu} , p^{\nu} \right\} - \left\{ p^{\mu} , x^{\nu} \right\} \right) = - i \mu \eta ^{\mu \nu}
\end{equation*}
\begin{align*}
    \left\{ x^{\mu} , x^{\nu} \right\} & = 0 = \left\{ p^{\mu} , p^{\nu} \right\}             \\
    \left\{ x^{\mu} , p^{\nu} \right\} & = \frac{1}{16 \pi ^2 (\alpha ')^3} \eta ^{\mu \nu} .
\end{align*}
This suggests that perhaps for the relation to reduce to the expected value of 1, the slope parameter should be
\begin{equation*}
    \alpha ' = \frac{1}{(16 \pi ^2)^{1/3}} .
\end{equation*}
