...
\begin{multline*}
    \left\{ X^{\mu} (\tau , \sigma) , \Pi ^{\nu} (\tau , \sigma ') \right\} = \bigg\{ \frac{1}{2 \pi \alpha '} \sum _{n} \frac{1}{2 E_{n}} \left( \alpha ^{\mu} _{n} \e ^{i (- E_{n} \tau + n \sigma)} + (\alpha ^{\mu} _{- n})^{*} \e ^{i (E_{n} \tau + n \sigma)} \right) , \\
    F^{-} \frac{i}{(4 \pi \alpha ')^2} \sum _{p} \left( - \alpha ^{\nu} _{p} \e ^{i (- E_{p} \tau + p \sigma ')} + (\alpha ^{\nu} _{- p})^{*} \e ^{i (E_{p} \tau + p \sigma ')} \right) \bigg\} = \delta (\sigma - \sigma ') \eta ^{\mu \nu}
\end{multline*}
\begin{multline*}
    \frac{i}{4 (2 \pi \alpha ')^3} \sum _{n} \frac{1}{2 E_{n}} \sum _{p} \bigg( - F^{-} \left\{ \alpha ^{\mu} _{n} , \alpha ^{\nu} _{p} \right\} \e ^{- i (E_{n} + E_{p}) \tau} \e ^{i n \sigma} \e ^{i p \sigma '} + F^{-} \left\{ \alpha ^{\mu} _{n} , (\alpha ^{\nu} _{- p})^{*} \right\} \e ^{- i (E_{n} - E_{p}) \tau} \e ^{i n \sigma} \e ^{i p \sigma '} - \\
    - F^{-} \left\{ (\alpha ^{\mu} _{- n})^{*} , \alpha ^{\nu} _{p} \right\} \e ^{i (E_{n} - E_{p}) \tau} \e ^{i n \sigma} \e ^{i p \sigma '} + F^{-} \left\{ (\alpha ^{\mu} _{- n})^{*} , (\alpha ^{\nu} _{- p})^{*} \right\} \e ^{i (E_{n} + E_{p}) \tau} \e ^{i n \sigma} \e ^{i p \sigma '} \bigg) = \delta (\sigma - \sigma ') \eta ^{\mu \nu}
\end{multline*}
\begin{equation*}
    \Bigg\downarrow \frac{1}{2 \pi} \int _{0} ^{2 \pi} \diff \sigma \e ^{- i m \sigma}
\end{equation*}
\begin{multline*}
    \frac{i}{4 (2 \pi \alpha ')^3} \frac{1}{2 E_{m}} \sum _{p} \bigg( - F^{-} \left\{ \alpha ^{\mu} _{m} , \alpha ^{\nu} _{p} \right\} \e ^{- i (E_{m} + E_{p}) \tau} \e ^{i p \sigma '} + F^{-} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{- p})^{*} \right\} \e ^{- i (E_{m} - E_{p}) \tau} \e ^{i p \sigma '} - \\
    - F^{-} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{p} \right\} \e ^{i (E_{m} - E_{p}) \tau} \e ^{i p \sigma '} + F^{-} \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{- p})^{*} \right\} \e ^{i (E_{m} + E_{p}) \tau} \e ^{i p \sigma '} \bigg) = \frac{1}{2 \pi} \e ^{- i m \sigma '} \eta ^{\mu \nu}
\end{multline*}
\begin{equation*}
    \Bigg\downarrow \frac{1}{2 \pi} \int _{0} ^{2 \pi} \diff \sigma ' \e ^{i k \sigma '}
\end{equation*}
\begin{equation*}
    \frac{1}{2 \pi} \int _{0} ^{2 \pi} \diff \sigma ' F^{-} \e ^{i (p + k) \sigma '} , \ F^{-} = \sum _{l} \left( A_{l} \e ^{i (E_{l} \tau + l \sigma ')} + (A_{- l})^{*} \e ^{i (- E_{l} \tau + l \sigma ')} \right)
\end{equation*}
\begin{multline*}
    \frac{i}{4 (2 \pi \alpha ')^3} \frac{1}{2 E_{m}} \bigg( - \sum _{l} \left( A_{l} \e ^{i E_{l} \tau} + (A_{- l})^{*} \e ^{- i E_{l} \tau} \right) \left\{ \alpha ^{\mu} _{m} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{- (E_{m} + E_{k + l}) \tau} + \\
    + \sum _{l} \left( A_{l} \e ^{i E_{l} \tau} + (A_{- l})^{*} \e ^{- i E_{l} \tau} \right) \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{- i (E_{m} - E_{k + l}) \tau} - \\
    - \sum _{l} \left( A_{l} \e ^{i E_{l} \tau} + (A_{- l})^{*} \e ^{- i E_{l} \tau} \right) \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i (E_{m} - E_{k + l}) \tau} + \\
    + \sum _{l} \left( A_{l} \e ^{i E_{l} \tau} + (A_{- l})^{*} \e ^{- i E_{l} \tau} \right) \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{i (E_{m} + E_{k + l}) \tau} \bigg) = \frac{1}{2 \pi} \delta _{m , k} \eta ^{\mu \nu}
\end{multline*}
\begin{multline*}
    \frac{i}{4 (2 \pi \alpha ')^3} \frac{1}{2 E_{m}} \sum _{l} \bigg( - A_{l} \left\{ \alpha ^{\mu} _{m} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{- (E_{m} + E_{k + l} + E_{l}) \tau} - (A_{- l})^{*} \left\{ \alpha ^{\mu} _{m} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{- (E_{m} + E_{k + l} - E_{l}) \tau} + \\
    + A_{l} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{- i (E_{m} - E_{k + l} + E_{l}) \tau} + (A_{- l})^{*} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{- i (E_{m} - E_{k + l} - E_{l}) \tau} - \\
    - A_{l} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i (E_{m} - E_{k + l} + E_{l}) \tau} - (A_{- l})^{*} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i (E_{m} - E_{k + l} - E_{l}) \tau} + \\
    + A_{l} \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{i (E_{m} + E_{k + l} + E_{l}) \tau} + (A_{- l})^{*} \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{i (E_{m} + E_{k + l} - E_{l}) \tau} \bigg) = \frac{1}{2 \pi} \delta _{m , k} \eta ^{\mu \nu} .
\end{multline*}
Since the R.H.S don't have $\tau$ dependence, this immediatelly gives us that
\begin{equation*}
    \left\{ \alpha ^{\mu} _{m} , \alpha ^{\nu} _{- k} \right\} = 0 = \left\{ (\alpha ^{\mu} _{- m})^{*} , (\alpha ^{\nu} _{k})^{*} \right\} ,
\end{equation*}
thus we simplify down to
\begin{multline*}
    \frac{i}{4 (2 \pi \alpha ')^3} \frac{1}{2 E_{m}} \sum _{l} \bigg( A_{l} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{- i (E_{m} - E_{k + l} + E_{l}) \tau} + (A_{- l})^{*} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \e ^{- i (E_{m} - E_{k + l} - E_{l}) \tau} - \\
    - A_{l} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i (E_{m} - E_{k + l} + E_{l}) \tau} - (A_{- l})^{*} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \e ^{i (E_{m} - E_{k + l} - E_{l}) \tau} \bigg) = \frac{1}{2 \pi} \delta _{m , k} \eta ^{\mu \nu} .
\end{multline*}
...
\end{equation*}
\begin{multline*}
    \frac{i}{4 (2 \pi \alpha ')^3} \frac{1}{2 E_{m}} \sum _{l} \bigg( A_{l} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \delta _{E_{m} + E_{l} , E_{k + l}} + (A_{- l})^{*} \left\{ \alpha ^{\mu} _{m} , (\alpha ^{\nu} _{k + l})^{*} \right\} \delta _{E_{m} , E_{k + l} + E_{l}} - \\
    - A_{l} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \delta _{E_{m} + E_{l} , E_{k + l}} - (A_{- l})^{*} \left\{ (\alpha ^{\mu} _{- m})^{*} , \alpha ^{\nu} _{- (k + l)} \right\} \delta _{E_{m} , E_{k + l} + E_{l}} \bigg) = \frac{1}{2 \pi} \delta _{m , k} \eta ^{\mu \nu}
\end{multline*}
