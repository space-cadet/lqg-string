...
\begin{align*}
    \partial _{\tau} X^{\mu}   & = \frac{i}{2} \sum _{n \in \mathbb{Z}} \left( - a^{\mu} _{n} \e ^{i (- E_{n} \tau + n \sigma)} + b^{\mu} _{n} \e ^{i (E_{n} \tau + n \sigma)} \right)                 \\
    \partial _{\sigma} X^{\mu} & = \frac{i}{2} \sum _{n \in \mathbb{Z}} \frac{n}{E_{n}} \left( a^{\mu} _{n} \e ^{i (- E_{n} \tau + n \sigma)} + b^{\mu} _{n} \e ^{i (E_{n} \tau + n \sigma)} \right) .
\end{align*}
...
\begin{align*}
    L_{p} (\tau)             & := \sum _{n} \frac{p - n}{E_{p - n}} a^{\mu} _{n} a^{\nu} _{p - n} \eta _{\mu \nu} \e ^{- i (E_{n} + E_{p - n}) \tau} = 0         \\
    \widetilde{L}_{p} (\tau) & := \sum _{n} \frac{p - n}{E_{p - n}} a^{\mu} _{n} (a^{\nu} _{n - p})^{*} \eta _{\mu \nu} \e ^{- i (E_{n} - E_{p - n}) \tau} = 0 .
\end{align*}

One last thing before quantizing: the $n = 0$ term in the solution reads
\begin{equation*}
    \frac{1}{2 m} \left( a^{\mu} _{0} \e ^{- i m \tau} + (a^{\mu} _{0})^{*} \e ^{i m \tau} \right) ,
\end{equation*}
which is divergent in the $m \rightarrow 0$ limit unless $\mathfrak{Re}(a^{\mu} _{0}) = 0$, thus $a^{\mu} _{0}$ must be purely imaginary. Keeping the analogy to the $m \rightarrow 0$ regime, we conclude $a^{\mu} _{0} = 4 \pi i (\alpha ')^2 p^{\mu}$. Also, I forgot to include a factor of $T = 1 / 2 \pi \alpha '$, so the solution is really
\begin{equation*}
