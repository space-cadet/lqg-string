...
\end{equation*}
where $S , T \in \mathrm{SL}(2 , \R)$, so we have a gauge freedom in choosing $h_{a b}$. This also implies
\begin{align*}
    \partial _{a} X^{\mu} \partial _{b} X^{\nu} H_{\mu \nu}                                       & = S_{a c} g^{c d} T_{d b} =                                                                                                                      \\
                                                                                                  & = S_{a c} \left( \frac{1}{2 g} \varepsilon ^{c c'} \varepsilon ^{d d'} g_{c' d'} \right) T_{d b} =                                               \\
...
\end{align*}
\begin{equation*}
    \delta _{a} ^{c'} \delta _{b} ^{d'} H_{\mu \nu} = \frac{1}{2 g} S_{a c} \varepsilon ^{c c'} T_{d b} \varepsilon ^{d d'} G_{\mu \nu}
\end{equation*}
\begin{equation*}
    H_{\mu \nu} = - \frac{1}{8 g} S_{a c} \varepsilon ^{c a} T_{d b} \varepsilon ^{b d} G_{\mu \nu}
\end{equation*}
\begin{equation*}
    H_{\mu \nu} = \frac{1}{8 (- g)} \Tr (S \varepsilon) \Tr (T \varepsilon) G_{\mu \nu}
\end{equation*}
\begin{equation*}
    H_{\mu \nu} = \frac{1}{8 (- g)} \Tr (S \varepsilon) \Tr (T (- \varepsilon ^{T})) G_{\mu \nu}
\end{equation*}
\begin{equation*}
    H_{\mu \nu} = \frac{1}{8 g} \Tr (S \varepsilon) \Tr ((\varepsilon T)^{T}) G_{\mu \nu}
\end{equation*}
\begin{equation*}
    H_{\mu \nu} = \frac{1}{8 g} \Tr (S \varepsilon) \Tr (\varepsilon T) G_{\mu \nu}
\end{equation*}
\begin{equation*}
    H_{\mu \nu} = \frac{1}{8 g} \Tr (S \varepsilon) \Tr (T \varepsilon) G_{\mu \nu} ,
\end{equation*}
where we must impose that $\Tr (S \varepsilon) \Tr (T \varepsilon) = - 8$ to recover the NG area corrected action. This restricts $S$ and $T$ to necessarily being not symmetric, otherwise the trace vanishes and we would get $H_{\mu \nu} = 0$.
\begin{equation*}
    (T^{-1})^{a c} g_{c d} (S^{-1})^{d b} = \frac{1}{2 g^{-1}} \varepsilon ^{a a'} \varepsilon ^{b b'} S_{a' c} g^{c d} T_{d b'}
\end{equation*}
...
\begin{equation*}
    \partial _{a} \left( \left( \sqrt{- g} g^{a b} - \frac{k \Delta}{2 (- g)} \sqrt{- g}^{-1} (T^{-1})^{a c} g_{c d} (S^{-1})^{d b} \right) \partial _{b} X^{\mu} \right) = 0 ,
\end{equation*}
which in conformal gauge $g_{a b} = \phi \eta _{a b}$ with $(T^{-1})^{a c} \eta _{c d} (S^{-1})^{d b} = \eta ^{a b}$ reduces further
\begin{equation*}
