...
implies that
\begin{equation*}
    \bra{0 ; p} \Hat{M}^2 \ket{0 ; p} = \frac{4}{\alpha '} \left( \frac{2 \mu ^2}{\alpha '} \bra{0 ; p} \Hat{x}^{\mu} \Hat{x}_{\mu} \ket{0 ; p} - \left( \sum _{n \neq 0} \left( \left( 1 \mp \frac{n}{E_{n}} \right) ^2 E_{n} \right) \bra{0 ; p} (\Hat{a}^{\mu} _{n})^{\dagger} \Hat{a}^{\nu} _{n} \eta _{\mu \nu} \ket{0 ; p} - \bra{0 ; p} c \ket{0 ; p} \right) \right)
\end{equation*}
\begin{equation*}
    M^2 = \frac{4}{\alpha '} \left( \frac{2 \mu ^2}{\alpha '} \frac{\partial \psi ^{*} (p)}{\partial p_{\mu}} \frac{\partial \psi (p)}{\partial p^{\mu}} + c \right)
\end{equation*}
\begin{equation*}
    \frac{\alpha '}{4} p^2 = - \left( \frac{2 \mu ^2}{\alpha '} \left| \frac{\partial \psi (p)}{\partial p} \right| ^2 + c \right)
\end{equation*}
...
\begin{multline*}
    \bra{0 ; p} \Hat{a}^{\mu} _{1} \zeta _{\mu} \Hat{M}^2 \zeta _{\nu} (\Hat{a}^{\nu} _{1})^{\dagger} \ket{0 ; p} = \frac{4}{\alpha '} \Bigg( \frac{2 \mu ^2}{\alpha '} \bra{0 ; p} \Hat{a}^{\mu} _{1} \zeta _{\mu} \Hat{x}^{\mu '} \Hat{x}_{\mu '} \zeta _{\nu} (\Hat{a}^{\nu} _{1})^{\dagger} \ket{0 ; p} - \\
...
\end{multline*}
\begin{equation*}
    M^2 \zeta ^{\mu} \zeta _{\mu} = \frac{4}{\alpha '} \left( \frac{2 \mu ^2}{\alpha '} \left| \frac{\partial \psi (p)}{\partial p} \right| ^2 \zeta ^{\mu} \zeta _{\mu} - \left( \left( 1 \mp \frac{1}{\sqrt{1 + \mu ^2}} \right) ^2 \sqrt{1 + \mu ^2} \right) \zeta ^{\mu} \zeta _{\mu} + c \zeta ^{\mu} \zeta _{\mu} \right)
\end{equation*}
\begin{equation*}
