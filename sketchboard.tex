...
Subtracting the vanishing matrix elements of the constraints we learn that
\begin{equation*}
    \Hat{\widetilde{L}}_{n , 0} = \Hat{L}_{n , 0} + a .
\end{equation*}

The commutation relations between the $L$'s are
\begin{align*}
    \Big[ \Hat{L}_{n , m} , \Hat{L}_{p , k} \Big]             & = 0 \\
    \Big[ \Hat{L}_{n , m} , \Hat{\widetilde{L}}_{p , k} \Big] & =
\end{align*}
