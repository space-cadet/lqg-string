...
\end{multline*}
\begin{equation*}
    \left( (\partial _t \tau)^2 - v^2 (\partial _x \tau)^2 \right) \partial ^2 _{\tau} X^{\mu} + \left( (\partial _t \sigma)^2 - v^2 (\partial _x \sigma)^2 \right) \partial ^2 _{\sigma} X^{\mu} + 2 \left( \partial _t \tau \partial _t \sigma - v^2 \partial _x \tau \partial _x \sigma \right) \partial _{\tau} \partial _{\sigma} X^{\mu} = 0
\end{equation*}
where $v = 1 / F^{+}$. Without loss of generality, we can set (just rescale/rotate the coordinates)
\begin{align*}
    (\partial _t \sigma)^2 - v^2 (\partial _x \sigma)^2 & = v^2 (\partial _x \tau)^2 - (\partial _t \tau)^2 \\
    \partial _t \tau \partial _t \sigma                 & = v^2 \partial _x \tau \partial _x \sigma
\end{align*}
