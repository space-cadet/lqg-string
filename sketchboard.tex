...
\begin{equation*}
    \left\{ \alpha ^{\mu} _{0} , (\alpha ^{\nu} _{0})^{*} \right\} = - i \frac{4 \pi (\alpha ')^{*}}{F^{-}} E_{0} \eta ^{\mu \nu}
\end{equation*}
\begin{equation*}
    \left\{ 2 \pi \alpha ' \mu x^{\mu} + 4 \pi i (\alpha ')^{2} p^{\mu} , 2 \pi \alpha ' \mu x^{\mu} - 4 \pi i (\alpha ')^{2} p^{\mu} \right\} = - i \frac{4 \pi (\alpha ')^{*}}{F^{-}} \mu \eta ^{\mu \nu}
\end{equation*}
\begin{align*}
    \left\{ x^{\mu} , x^{\nu} \right\} & = \left\{ p^{\mu} , p^{\nu} \right\} = 0 \\
    \left\{ x^{\mu} , p^{\nu} \right\} & \propto \eta ^{\mu \nu}
\end{align*}
