...
\end{multline*}
Once more, we see that the middle 2 terms and outer 2 terms are complex conjugate pairs, so we're left with
...
\end{align*}
These can be solved with the use of the 1D wave Green's function $\Theta (| \sigma | - \tau)$
