...
\subsection{Checking Poincaré invariance}

Under a global infinitesimal Poincaré transformation $X \mapsto X + (\epsilon ^{\mu \nu} M_{\mu \nu} + \epsilon ^{\mu} P_{\mu}) X$ where $\epsilon ^{\mu \nu} = - \epsilon ^{\nu \mu}$ and $\epsilon ^{\mu}$ are infinitesimal constants and $M_{\mu \nu} = B_{0 \alpha} + J_{\alpha \beta}$ are the generators of Lorentz transformations, the action changes as
\begin{equation*}
	\delta \Lagr = \delta \left( e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} \mc{D}_{a} X^{I} \mc{D}_{b} X^{J} \eta _{I J} \right) =
\end{equation*}
\begin{equation*}
	= e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} \delta \left( \mc{D}_{a} X^{I} \mc{D}_{b} X^{J} \right) \eta _{I J} =
\end{equation*}
\begin{equation*}
	= e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} \left( \mc{D}_{a} ((\epsilon ^{\mu \nu} M_{\mu \nu} + \epsilon ^{\mu} P_{\mu})^{I} _{\ K} X^{K}) \mc{D}_{b} X^{J} + \mc{D}_{a} X^{I} \mc{D}_{b} ((\epsilon ^{\mu \nu} M_{\mu \nu} + \epsilon ^{\mu} P_{\mu})^{J} _{\ K} X^{K}) \right) \eta _{I J} =
\end{equation*}
\begin{equation*}
	= e e^{a} _{I'} e^{b} _{J'} \eta ^{I' J'} \left( (\epsilon ^{\mu \nu} M_{\mu \nu} + \epsilon ^{\mu} P_{\mu})^{I} _{\ K} \mc{D}_{a} X^{K} \mc{D}_{b} X^{J} + (\epsilon ^{\mu \nu} M_{\mu \nu} + \epsilon ^{\mu} P_{\mu})^{J} _{\ K} \mc{D}_{a} X^{K} \mc{D}_{b} X^{I} \right) \eta _{I J} =
\end{equation*}
\begin{equation*}
	=
\end{equation*}
