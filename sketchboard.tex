...
\end{multline*}
Since this must hold for all values of $\tau$ and $\sigma$, we have that each term must vanish
\begin{align*}
    a^{\mu} _{n} a^{\nu} _{k} \eta _{\mu \nu}                 & = 0   \\
    a^{\mu} _{n} (a^{\nu} _{- k})^{*} \eta _{\mu \nu}         & = 0   \\
    (a^{\mu} _{- n})^{*} a^{\nu} _{k} \eta _{\mu \nu}         & = 0   \\
...
Now analysing the other constraint, it reads $(\partial _{\tau} X^{\mu} \partial _{\tau} X^{\nu} + \partial _{\sigma} X^{\mu} \partial _{\sigma} X^{\nu}) \eta _{\mu \nu} = 0$. The first term here is
\begin{multline*}
    \partial _{\tau} X^{\mu} \partial _{\tau} X^{\nu} \eta _{\mu \nu} = - \frac{\eta _{\mu \nu}}{4} \sum _{n} \sum _{k} \Big( a^{\mu} _{n} a^{\nu} _{k} \e ^{- i (E_{n} + E_{k}) \tau} \e ^{i (n + k) \sigma} \Big)
\end{multline*}
