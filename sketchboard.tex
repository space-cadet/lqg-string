...
\end{equation*}
Assuming the pullback to WS retains the form we have
\begin{equation*}
    \mc{A}_{a} = - \begin{bmatrix} 0                        & \partial _{\tau} a(\tau) & \partial _{\tau} a(\tau) & ... & \partial _{\tau} a(\tau) \\
                \partial _{\tau} a(\tau) & 0                        & 0                        & ... & 0                        \\ \partial _{\tau} a(\tau) & 0 & 0 & ... & 0 \\ \vdots & & & & \vdots \\ \partial _{\tau} a(\tau) & 0 & 0 & ... & 0\end{bmatrix}
\end{equation*}
