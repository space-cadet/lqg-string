...
\begin{equation*}
    E^{2} = p^2 + \sum _{n = 0} ^{D} m_{n} ^2 \frac{p^{n}}{E_{pl} ^{n}} .
\end{equation*}
This action has manifest Lorentz invariance and WS reparameterisation and Weyl invariance. As for translational symmetry, it holds approximately for the fields with $m_{\mu} >> T$.
