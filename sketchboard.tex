...
\end{multline*}
which, without loss of generality, we can set
\begin{align*}
    (F^{+})^2 \left( \frac{\partial \sigma}{\partial t} \right) ^2 - \left( \frac{\partial \sigma}{\partial x} \right) ^2 & = \left( \frac{\partial \tau}{\partial x} \right) ^2 - (F^{+})^2 \left( \frac{\partial \tau}{\partial t} \right) ^2 \\
    (F^{+})^2 \frac{\partial \tau}{\partial t} \frac{\partial \sigma}{\partial t}                                         & = \frac{\partial \tau}{\partial x} \frac{\partial \sigma}{\partial x}
\end{align*}
