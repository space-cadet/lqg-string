...
\begin{equation*}
    \ket{\psi _{n , n'}} = \sum _{m} \Hat{\widetilde{L}}_{n , m} \ket{\widetilde{\chi}_{n' , m}}
\end{equation*}
where $\ket{\widetilde{\chi}_{n' , m}}$ satisfies
\begin{align*}
    \Hat{\widetilde{L}}_{k , p} \ket{\widetilde{\chi}_{n' , m}}                                                                                                                  & = 0 , \ k \neq - p \\
    \left( \sum _{n'} \left( \left( \left( \frac{n'}{E_{n'}} \right) ^2 - 1 \right) \Hat{\widetilde{L}}_{n' , - n'} \right) - c - n' - m \right) \ket{\widetilde{\chi}_{n' , m}} & = 0 .
\end{align*}
These states are annihilated by $\Hat{\widetilde{L}}_{k , p}$, for $p \neq - n$, and for this case we have that
\begin{equation*}
    \sum _{n} \left( \left( \left( \frac{n}{E_{n}} \right) ^2 - 1 \right) \Hat{\widetilde{L}}_{- p , - n} \ket{\psi _{n , n'}} \right) =
\end{equation*}
\begin{equation*}
    = \sum _{n} \left( \left( \left( \frac{n}{E_{n}} \right) ^2 - 1 \right) \Hat{\widetilde{L}}_{- p , - n} \sum _{m} \Hat{\widetilde{L}}_{n , m} \ket{\widetilde{\chi}_{n' , m}} \right)  =
\end{equation*}
\begin{equation*}
    = \sum _{n} \left( \left( \left( \frac{n}{E_{n}} \right) ^2 - 1 \right) \Hat{\widetilde{L}}_{n , - n} \right) \ket{\widetilde{\chi}_{n' , p}} ,
\end{equation*}
which vanish if $c = - (n' + p)$.
