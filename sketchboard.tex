...
\begin{equation*}
    \Hat{M}^2 = - \frac{1}{(4 \pi (\alpha ')^2)^2} \left( (\Hat{\alpha} ^{\mu} _{0})^{\dagger} \Hat{\alpha}^{\nu} _{0} \eta _{\mu \nu} + \lim _{n \rightarrow 0} \frac{E_{n}}{n} c_{n} \right) ,
\end{equation*}
so we get that the mass spectrum is shifted by the limit of $E_{n} c_{n} / n$. Since $E_{0} = \mu$, it seems reasonable to expect that the limit of $c_{n} / n$ will be proportional to $\mu$, such that the mass spectrum gets shifted by the KG \textquotedblleft mass" term $\mu ^2$.
...
\end{equation*}
Now considering states at the first excited level, given by $\zeta _{\mu} (\Hat{\alpha} ^{\mu} _{1})^{\dagger} \ket{0 ; k}$ with $\zeta _{\mu} (k)$ being a polarization vector, the mass-shell condition will now reads
\begin{equation*}
...
\end{equation*}
so the mass spectrum of excited states are the same as of the vacuum state.
