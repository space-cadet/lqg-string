...
\end{equation*}
\begin{equation*}
    \phi (\tau , \sigma) = \sqrt{\frac{k \Delta}{2 \left( 1 - \e ^{i (E \tau + p \sigma)} \right)}}
\end{equation*}
\begin{equation*}
    \downarrow
\end{equation*}
...
\begin{equation*}
    \e ^{i (E \tau + p \sigma)} = 1 - \frac{k \Delta}{2 \phi ^{2}}
\end{equation*}
\begin{equation*}
    \frac{k \Delta}{2 \phi ^{2}} = 1 - \e ^{i (E \tau + p \sigma)}
\end{equation*}
\begin{equation*}
    \phi ^2 = \frac{k \Delta}{2 \left( 1 - \e ^{i (E \tau + p \sigma)} \right)}
\end{equation*}
\begin{equation*}
    \phi = \sqrt{\frac{k \Delta}{2 \left( 1 - \e ^{i (E \tau + p \sigma)} \right)}}
\end{equation*}
