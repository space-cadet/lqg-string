...
\end{equation*}
so either the mass spectrum of the string diverges, or the constant $a$ isn't so constant and $a = n$, making the limit equal to $E_{0} = \mu$, the KG \textquotedblleft mass" term.
