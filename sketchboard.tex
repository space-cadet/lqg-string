...
\begin{multline*}
    ...
    + \left[ \Hat{\widetilde{L}}_{k , p} , \left( \Hat{\widetilde{L}}_{n , s} \delta _{r , - m} - \Hat{\widetilde{L}}_{r , m} \delta _{- m , k} + C_{r} \delta _{r , - m} + D_{n} \delta _{- s , n} \right) \right] = 0
\end{multline*}
\begin{multline*}
    ...
    - \left[ \Hat{\widetilde{L}}_{r , s} , \Hat{\widetilde{L}}_{n , p} \right] \delta _{- m , k} + \left[ \Hat{\widetilde{L}}_{k , p} , \Hat{\widetilde{L}}_{n , s} \right] \delta _{r , - m} - \left[ \Hat{\widetilde{L}}_{k , p} , \Hat{\widetilde{L}}_{r , m} \right] \delta _{- m , k} = 0
\end{multline*}
