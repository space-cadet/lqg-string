...
\begin{equation*}
    S = - \frac{T}{2} \int \diff ^2 x \sqrt{- g} - \frac{T'}{2} \int \diff ^2 x \sqrt{- h} ,
\end{equation*}
...
\end{equation*}
where $S \in \mathrm{SL}(2 , \mathbb{C})$, so we have a gauge freedom in choosing $h_{a b}$. This also implies
\begin{align*}
...
\end{equation*}
where we must impose that $(\Tr (S \varepsilon))^2 = - 8$ to recover the NG action. So, the group freedom we have for choosing $h$ becomes
\begin{equation*}
    G = \mathrm{SL}(2 , \mathbb{C}) \cup \left\{ S \in \mathrm{GL}(2 , \mathbb{C}) \ | \ (\Tr (S \varepsilon))^2 = - 8 \right\} =
\end{equation*}
\begin{equation*}
    = \left\{ \begin{bmatrix} a & b \\ c & d \end{bmatrix} \ \Bigg| \ a , b , c , d \in \mathbb{C} , \ a d - b c = 1 , \ (c - b)^2 = - 8 \right\}
\end{equation*}
