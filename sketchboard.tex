...
\begin{equation*}
    \mc{A}_{a} X = 
    \begin{bmatrix} X^{0} + n^{0} _{a} X^{r} \\
                    X^{1} + n^{1} _{a} X^{r} \\
                    X^{2} + n^{2} _{a} X^{r} \\
                    X^{3} + n^{3} _{a} X^{r} \\
                    X^{r} - (n^{0} _{a} X^{0} - \sum _{i = 1} ^{3} n^{i} _{a} X^{i}) \end{bmatrix}
\end{equation*}
\begin{equation*}
    \mc{A}_{a} \del _{b} X = \begin{bmatrix} \del _{b} X^{0} + n^{0} _{a} \del _{b} X^{r} \\
        \del _{b} X^{1} + n^{1} _{a} \del _{b} X^{r} \\
        \del _{b} X^{2} + n^{2} _{a} \del _{b} X^{r} \\
        \del _{b} X^{3} + n^{3} _{a} \del _{b} X^{r} \\
        \del _{b} X^{r} - (n^{0} _{a} \del _{b} X^{0} - \sum _{i = 1} ^{3} n^{i} _{a} \del _{b} X^{i}) \end{bmatrix}
\end{equation*}
\begin{equation*}
    \del _{a} \mc{A}_{b} X = \begin{bmatrix} X^{0} + \del _{a} n^{0} _{b} X^{r} \\
        X^{1} + \del _{a} n^{1} _{b} X^{r} \\
        X^{2} + \del _{a} n^{2} _{b} X^{r} \\
        X^{3} + \del _{a} n^{3} _{b} X^{r} \\
        X^{r} - (\del _{a} n^{0} _{b} X^{0} - \sum _{i = 1} ^{3} \del _{a} n^{i} _{b} X^{i}) \end{bmatrix}
\end{equation*}
\begin{equation*}
    \mc{A}_{a} \mc{A}_{b} X = \mc{A}_{a} \begin{bmatrix} X^{0} + n^{0} _{b} X^{r} \\
        X^{1} + n^{1} _{b} X^{r} \\
        X^{2} + n^{2} _{b} X^{r} \\
        X^{3} + n^{3} _{b} X^{r} \\
        X^{r} - (n^{0} _{b} X^{0} - \sum _{i = 1} ^{3} n^{i} _{b} X^{i}) \end{bmatrix} =
\end{equation*}
\begin{equation*}
    = \begin{bmatrix} X^{0} + n^{0} _{b} X^{r} + n^{0} _{a} (X^{r} - (n^{0} _{b} X^{0} - \sum _{i = 1} ^{3} n^{i} _{b} X^{i})) \\
        X^{1} + n^{1} _{b} X^{r} + n^{1} _{a} (X^{r} - (n^{0} _{b} X^{0} - \sum _{i = 1} ^{3} n^{i} _{b} X^{i})) \\
        X^{2} + n^{2} _{b} X^{r} + n^{2} _{a} (X^{r} - (n^{0} _{b} X^{0} - \sum _{i = 1} ^{3} n^{i} _{b} X^{i})) \\
        X^{3} + n^{3} _{b} X^{r} + n^{3} _{a} (X^{r} - (n^{0} _{b} X^{0} - \sum _{i = 1} ^{3} n^{i} _{b} X^{i})) \\
        X^{r} - (n^{0} _{b} X^{0} - \sum _{i = 1} ^{3} n^{i} _{b} X^{i}) - (n^{0} _{a} (X^{0} + n^{0} _{b} X^{r}) - \sum _{i = 1} ^{3} n^{i} _{a} (X^{i} + n^{i} _{b} X^{r})) \end{bmatrix} =
\end{equation*}
\begin{equation*}
    = \begin{bmatrix} X^{\prime 0} _{b} + n^{0} _{a} X^{\prime r} _{b} \\
        X^{\prime 1} _{b} + n^{1} _{a} X^{\prime r} _{b} \\
        X^{\prime 2} _{b} + n^{2} _{a} X^{\prime r} _{b} \\
        X^{\prime 3} _{b} + n^{3} _{a} X^{\prime r} _{b} \\
        X^{\prime r} _{b} - (n^{0} _{a} X^{\prime 0} _{b} - \sum _{i = 1} ^{3} n^{i} _{a} X^{\prime i} _{b}) \end{bmatrix} , \ X^{\prime \mu} _{b} = X^{\mu} + n^{\mu} _{b} X^{r} , \ X^{\prime r} _{b} = X^{r} - (n^{0} _{b} X^{0} - \sum _{i = 1} ^{3} n^{i} _{b} X^{i})
\end{equation*}
