...
..., promote partial derivative to covariant derivative and build a linear action with inclusion of new bulk field
\begin{equation*}
    S_{L P} = - \frac{T}{2} \int \diff \tau \wedge \diff \sigma e e^{a} _{i} D_{a} X^{\mu i} E^{I} _{\mu} V_{I}
\end{equation*}
...
\end{equation*}
\begin{equation*}
    T^{l} _{e} := E_{\mu} ^{I} E_{\nu I} (- e^{l} _{e} e^{a} _{i} e^{b} _{j} D_{a} X^{\mu i} D_{b} X^{\nu j} + e^{a} _{i} D_{a} X^{\mu i} D_{e} X^{\nu l}) = 0
\end{equation*}
\begin{equation*}
    \Downarrow
\end{equation*}
...
\begin{align*}
    \frac{\delta S_{L P}}{\delta \delta e^{b} _{j}} & = \frac{D \Lagr _{L P}}{D e^{b} _{j}} = \left( \frac{\partial}{\partial e^{b} _{j}} - \partial _{e} \frac{\partial}{\partial (\partial _{e} e^{b} _{j})} \right) \left( - \frac{T}{2} e e^{a} _{i} D_{a} X^{\mu i} E^{I} _{\mu} V_{I} \right) = \\
                                                    & = - \frac{T}{4} \varepsilon ^{c d} \varepsilon _{m n} ((g_{c b} \eta ^{m j} e^{n} _{d} + e^{m} _{c} g_{d b} \eta ^{n j}) e^{a} _{i} + e^{m} _{c} e^{n} _{d} \delta ^{a} _{b} \delta ^{j} _{i}) D_{a} X^{\mu i} E^{I} _{\mu} V_{I} =             \\
                                                    & = - \frac{T}{2} (- e e^{j} _{b} e^{a} _{i} D_{a} X^{\mu i} E^{I} _{\mu} V_{I} + e D_{b} X^{\mu j} E^{I} _{\mu} V_{I}) \overset{!}{=} 0
\end{align*}
\begin{equation*}
    \downarrow
\end{equation*}
\begin{equation*}
    T^{j} _{b} := D_{b} X^{\mu j} E^{I} _{\mu} V_{I} - e^{j} _{b} e^{a} _{i} D_{a} X^{\mu i} E^{I} _{\mu} V_{I} = 0
\end{equation*}
\begin{equation*}
    \downarrow
\end{equation*}
\begin{equation*}
    e^{j} _{b} = F D_{b} X^{\mu j} E^{I} _{\mu} V_{I} ,
\end{equation*}
\begin{equation*}
    \frac{1}{F} = e^{a} _{i} D_{a} X^{\mu i} E^{I} _{\mu} V_{I}
\end{equation*}
