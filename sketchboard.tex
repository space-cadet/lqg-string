...
\begin{multline*}
    \left[ \Hat{X}^{\mu} (\tau , \sigma) , \Hat{X}^{\nu} (\tau , \sigma ') \right] = \Big[ \frac{1}{2 \pi \alpha '} \sum _{p \in \mathbb{Z}} \frac{1}{2 E_{p}} \Big( \Hat{\alpha} ^{\mu} _{p} \e ^{i (- E_{p} \tau + p \sigma)} + (\Hat{\alpha} ^{\mu} _{- p})^{\dagger} \e ^{i (E_{p} \tau + p \sigma)} \Big) , \\
        \frac{1}{2 \pi \alpha '} \sum _{n \in \mathbb{Z}} \frac{1}{2 E_{n}} \Big( \Hat{\alpha} ^{\mu} _{n} \e ^{i (- E_{n} \tau + n \sigma)} + (\Hat{\alpha} ^{\mu} _{- n})^{\dagger} \e ^{i (E_{n} \tau + n \sigma)} \Big) \Big] =
\end{multline*}
\begin{multline*}
    = \frac{1}{(4 \pi \alpha ')^2} \sum _{p} \sum _{n} \frac{1}{E_{p} E_{n}} \Big( \Big[  \Big] \Big)
\end{multline*}
