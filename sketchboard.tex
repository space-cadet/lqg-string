...
\begin{align*}
    \partial _{a} \left( \sqrt{- g^{-1}} (g^{-1})^{b c} \right) & \rightarrow \partial _{a} \left( \sqrt{- g^{-1}} U^{b} _{\ b'} (g^{-1})^{b' c'} U^{\ c} _{c'} \right) =                                                                                                                 \\
                                                                & = U ^{b} _{\ b'} \partial _{a} (\sqrt{- g^{-1}} (g^{-1})^{b' c'}) U^{\ c} _{c'} + \sqrt{- g^{-1}} (g^{-1})^{b' c'} \left( \partial _{a} U^{b} _{\ b'} U^{\ c} _{c'} + U^{b} _{\ b'} \partial _{a} U^{\ c} _{c'} \right)
\end{align*}
\begin{equation*}
    \Downarrow
\end{equation*}
\begin{equation*}
    A' _{a} U^{b} _{\ b'} \sqrt{- g^{-1}} (g^{-1})^{b' c'} U^{\ c} _{c'} = A_{a} U^{b} _{\ b'} \sqrt{- g^{-1}} (g^{-1})^{b' c'} U^{\ c} _{c'} - \sqrt{- g^{-1}} (g^{-1})^{b' c'} (\partial _{a} U^{b} _{\ b'} U^{\ c} _{c'} + U^{b} _{\ b'} \partial _{a} U^{\ c} _{c'})
\end{equation*}
