...
\begin{equation*}
    \mc{A} _{\mu} = A^{A B} _{\mu} T_{A B} = A^{0 (i)} _{i} T_{0 (i)} = - \partial _{t} a(t) \sum _{i = 1} ^{d} T_{0 i} = - \begin{bmatrix} 0                  & \partial _{t} a(t) & \partial _{t} a(t) & ... & \partial _{t} a(t) \\
                \partial _{t} a(t) & 0                  & 0                  & ... & 0                  \\ \partial _{t} a(t) & 0 & 0 & ... & 0 \\ \vdots & & & & \vdots \\ \partial _{t} a(t) & 0 & 0 & ... & 0\end{bmatrix} .
\end{equation*}
Pullback of connection gives
\begin{equation*}
    \mc{A}_{a} = \frac{\partial X^{\mu}}{\partial x^{a}} \mc{A}_{\mu} = - \partial _{a} a(\tau , \sigma) \begin{bmatrix} 0 & 1 & 1 & ... & 1 \\
                1 & 0 & 0 & ... & 0 \\ 1 & 0 & 0 & ... & 0 \\ \vdots & & & & \vdots \\ 1 & 0 & 0 & ... & 0\end{bmatrix}
\end{equation*}
\begin{equation*}
    \mc{A}_{a} \mc{A}_{b} = \partial _{a} a(\tau , \sigma) \partial _{b} a(\tau , \sigma) \begin{bmatrix} d & 0 & ... & 0 \\ 0 & d & ... & 0 \\ \vdots & & & \vdots \\ 0 & 0 & ... & d \end{bmatrix}
\end{equation*}
\begin{equation*}
    \partial _{a} \mc{A}_{b} = - \partial _{a} \partial _{b} a(\tau , \sigma) \begin{bmatrix} 0 & 1 & 1 & ... & 1 \\
                1 & 0 & 0 & ... & 0 \\ 1 & 0 & 0 & ... & 0 \\ \vdots & & & & \vdots \\ 1 & 0 & 0 & ... & 0\end{bmatrix}
\end{equation*}
\begin{equation*}
    \mc{A}_{a} X = - \partial _{a} a(\tau , \sigma) \begin{bmatrix} 0 & 1 & 1 & ... & 1 \\
                1 & 0 & 0 & ... & 0 \\ 1 & 0 & 0 & ... & 0 \\ \vdots & & & & \vdots \\ 1 & 0 & 0 & ... & 0\end{bmatrix} \begin{bmatrix} X^{0} \\ X^{1} \\ X^{2} \\ \vdots \\ X^{d} \end{bmatrix} = - \partial _{a} a (\tau , \sigma) \begin{bmatrix} \sum _{i = 1} ^{d} X^{i} \\ X^{0} \\ X^{0} \\ \vdots \\ X^{0} \end{bmatrix} .
\end{equation*}

Solution thus becomes
\begin{equation*}
    X (x) = - \int \diff ^2 x' \underline{G} (x ; x') \eta ^{a' b'} \left( - k \partial _{a'} \partial _{b'} a (x') \sum _{i} T_{0 (i)} X (x') + k^2 d \partial _{a'} a (x') \partial _{b'} a (x') X (x') \right)
\end{equation*}
where the Green's matrix satisfies
\begin{equation*}
    \eta ^{a b} \left( \mathbb{1} \partial _{a} \partial _{b} - 2 k \partial _{a} a (x) \sum _{i} T_{0 (i)} \partial _{b} \right) \underline{G} (x ; x') = \mathbb{1} \delta (x ; x')
\end{equation*}
