...
\end{align*}
\begin{equation*}
    \partial _{\tau} X^{\mu} \pm \partial _{\sigma} X^{\mu} = \frac{1}{4 \pi \alpha '} \sum _{n} \bigg( - a^{\mu} _{n} \bigg( \sin (E_{n} \tau) \pm i \frac{n}{E_{n}} \cos (E_{n} \tau) \bigg) \e ^{- i n \sigma} + (a^{\mu} _{n})^{*} \bigg( - \sin (E_{n} \tau) \pm i \frac{n}{E_{n}} \cos (E_{n} \tau) \bigg) \bigg) =
\end{equation*}
\begin{equation*}
...
\begin{multline*}
    (\partial _{\tau} X \pm \partial _{\sigma} X)^2 = - \frac{\eta _{\mu \nu}}{(4 \pi \alpha ')^2} \sum _{n} \sum _{p} \bigg( \bigg( 1 \mp \frac{n}{E_{n}} \bigg) \bigg( 1 \mp \frac{p}{E_{p}} \bigg) \bigg) \equiv 0 .
\end{multline*}
