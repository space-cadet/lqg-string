...
\end{equation*}
\begin{equation*}
    \partial _{\tau} \PS ^{\tau} _{\mu (N G)} + \partial _{\sigma} \PS ^{\sigma} _{\mu (N G)} = \frac{1}{\frac{2}{g \Delta} - (- h)^{-1}} \left( \PS ^{\tau} _{\mu (N G)} \frac{\partial (- h)^{-1}}{\partial \tau} + \PS ^{\sigma} _{\mu (N G)} \frac{\partial (- h)^{-1}}{\partial \sigma} \right) ,
\end{equation*}
...
\end{equation*}
\begin{equation*}
    \partial _{\tau} \PS ^{\tau 0} _{(N G)} + \partial _{\sigma} \PS ^{\sigma 0} _{(N G)} = \frac{1}{\frac{2}{g \Delta} - (- h)^{-1}} \left( \PS ^{\tau 0} _{(N G)} \frac{\partial (- h)^{-1}}{\partial \tau} + \PS ^{\sigma 0} _{(N G)} \frac{\partial (- h)^{-1}}{\partial \sigma} \right)
\end{equation*}
\begin{equation*}
    \downarrow
\end{equation*}
\begin{equation*}
    \frac{\partial}{\partial t} \left( T \frac{\diff s}{\diff \sigma} \gamma _{v_{\perp}} \right) = \frac{1}{\frac{2}{g \Delta} - (- h)^{-1}} T \frac{\diff s}{\diff \sigma} \gamma _{v_{\perp}} \frac{\partial (- h)^{-1}}{\partial t}
\end{equation*}
$\implies$ energy along string is no longer conserved, rather it changes according to time derivative of inverse determinant, either that or string energy get's redefined to (more likely actually)
\begin{equation*}
...
\end{equation*}
\begin{equation*}
    \mu \gamma _{v_{\perp}} \left( 1 - \frac{g \Delta}{2 (- h)} \right) \frac{\partial ^2 \Vec{X}}{\partial t^2} - \frac{\partial}{\partial s} \left[ \frac{T}{\gamma _{v_{\perp}}} \frac{\partial \Vec{X}}{\partial s} \left( 1 - \frac{g \Delta}{2 (- h)} \right) \right] = 0
\end{equation*}
