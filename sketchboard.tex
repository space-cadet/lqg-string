...
\begin{equation*}
    X^{r} (x) = X^{r} _{0} (x) - 2 \mu \int \diff ^{2} x' G (x ; x') \e ^{\varphi (x')} (2 + \mu X^{r} (x')) ,
\end{equation*}
\begin{equation*}
...
\end{equation*}
\begin{equation*}
    X^{r} (x) = X^{r} _{0} (x) + \sum _{k \geq 1} (- 2 \mu)^{k} \int (\diff ^2 x')^{k} (G' \e ^{\varphi '})^{k} (2 + \mu X^{r} _{0} (x^{(k)})) ,
\end{equation*}
where
\begin{equation*}
    \int (\diff ^2 x')^{k} = \int \diff ^2 x^{(1)} \int \diff ^2 x^{(2)} ... \int \diff ^2 x^{(k)}
\end{equation*}
\begin{equation*}
    (G' \e ^{\varphi '})^{k} = G (x ; x^{(1)}) \e ^{\varphi (x^{(1)})} G (x^{(1)} ; x^{(2)}) \e ^{\varphi (x^{(2)})} ... G (x^{(k-1)} ; x^{(k)}) \e ^{\varphi (x^{(k)})} .
\end{equation*}
