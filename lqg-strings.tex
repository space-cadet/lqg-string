...
In the following, we proceed to quantize the Klein-Gordon string via canonical covariant quantization, in a manner much similar to those found in \cite{Tong2009Lectures} and \cite{Green2012Superstring}. We turn the Poisson bracket relations into commutation relations between the now operator variables, $\{ , \} \mapsto i [ , ]$, yielding
\begin{align}
