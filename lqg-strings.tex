...
\end{equation}
The reason we can still use conformal gauge even tho our action no longer has Weyl symmetry is because of a theorem stating that {\it every 2d metric is conformal to the flat metric}(theorem 7.2 in\cite{Schottenloher}).
