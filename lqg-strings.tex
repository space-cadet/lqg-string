...
\end{equation}
where $S \in \mathrm{SL}(2 , \mathbb{C})$. The fact that we require $S = S^{\dagger}$ for $h$ to be real and symmetric restricts $S$ to be a boost. By requiring that the induced metric by $H_{\mu \nu}$ be equal to\eqref{eqn:h=SgS}, we get
