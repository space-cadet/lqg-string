...
\begin{equation}
	S'_{NG} = -T \int d^2 x \left( \sqrt{h} +  \frac{1}{2} \frac{g \Delta}{\sqrt{h}} \right).
\end{equation}
This action has, to the best of our knowledge, not been explored in the string theory literature. However, such an inverse area term arises very naturally in the LQG approach and goes by the name of ``inverse triad'' corrections.
