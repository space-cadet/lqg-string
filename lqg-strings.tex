...
\begin{multline} \label{eqn:KG-Polyakov-solution-initial}
	X^{\mu} (\tau , \sigma) = \frac{1}{2 \pi \alpha '} \sum _{p \in \mathbb{Z}} \frac{1}{2 E_{p}} \Big( \alpha ^{\mu} _{n} \e ^{i (- E_{p} \tau + p \sigma)} + \\
	+ \beta ^{\mu} _{n} \e ^{i (E_{p} \tau + p \sigma)} \Big) ,
\end{multline}
...
\begin{align}
	L_{n} (\tau)              & := \frac{1}{2} \sum _{p \in \mathbb{Z}} \frac{n - p}{E_{n - p}} \alpha ^{\mu} _{p} \alpha ^{\nu} _{n - p} \eta _{\mu \nu} \e ^{- i (E_{n} + E_{n - p}) \tau} \label{eqn:"Virasoro"-modes-1}         \\
	\widetilde{L} _{n} (\tau) & := \frac{1}{2} \sum _{p \in \mathbb{Z}} \frac{n - p}{E_{n - p}} \alpha ^{\mu} _{p} (\alpha ^{\nu} _{p - n})^{*} \eta _{\mu \nu} \e ^{- i (E_{n} - E_{n - p}) \tau} \label{eqn:"Virasoro"-modes-2} .
\end{align}
...
\begin{multline} \label{eqn:KG-Polyakov-solution-final}
	X^{\mu} (\tau , \sigma) = \frac{1}{2 \pi \alpha '} \sum _{p \in \mathbb{Z}} \frac{1}{2 \E_{p}} \Big( \alpha ^{\mu} _{n} \e ^{i (- E_{p} \tau + p \sigma)} + \\
	+ (\alpha ^{\mu} _{- n})^{*} \e ^{i (E_{p} \tau + p \sigma)} \Big)
\end{multline}
