...
We also briefly explored an alternative approach to incorporate LQG quantum geometric effects into string theory by considering Afshordi's ``emergent dimensions’’ model \cite{Afshordi2014Emergent} with some key insights from LQG complementing said model, creating a more concrete picture of the mechanism behind the emerging dimensions.
